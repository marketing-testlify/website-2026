...
const SOL: MenuTab[] = [
  {
    ...
    subs: [
      { label: 'Volume hiring', d: 'Screen thousands of applicants in hours', href: '#solutions' },
      { label: 'Remote hiring', d: 'Hire anywhere with proctored assessments', href: '#solutions' },
      { label: 'Campus hiring', d: 'Rank fresh graduates without resumes', href: '#solutions' },
      { label: 'Diversity & inclusion', d: 'Bias-free, EEOC-defensible screening', href: '#solutions' },
      { label: 'Technical hiring', d: '45+ coding languages with a live IDE', href: '#solutions' },
      { label: 'Staffing & agencies', d: 'Vet candidates before you submit them', href: '#solutions' },
    ],
  },
  {
    name: 'By industry',
    ...
    subs: [
      { label: 'IT & technology', d: 'Developers, DevOps, data & security', href: '#solutions' },
      { label: 'SaaS & software', d: 'GTM, product and engineering roles', href: '#solutions' },
      { label: 'Financial services', d: 'Analysts, ops and compliance-heavy roles', href: '#solutions' },
      { label: 'Healthcare', d: 'Clinical & administrative screening', href: '#solutions' },
      { label: 'Retail & e-commerce', d: 'High-volume frontline hiring', href: '#solutions' },
      { label: 'BPO & services', d: 'Multilingual, high-ramp hiring', href: '#solutions' },
    ],
  },
  {
    ...
    subs: [
      { label: 'Startups', d: 'Hire fast without a TA team', href: '#solutions' },
      { label: 'Mid-market', d: 'Standardize hiring as you scale', href: '#solutions' },
      { label: 'Enterprise', d: 'SSO, compliance and audit trails', href: '#solutions' },
      { label: 'Non-profits & public sector', d: 'Fair, defensible selection', href: '#solutions' },
    ],
  },
  {
    name: 'By test type',
    ...
    subs: [
      { label: 'Coding tests', d: 'Real-world dev challenges, 45+ languages', href: '#library' },
      { label: 'Cognitive ability', d: 'Reasoning & problem-solving', href: '#library' },
      { label: 'Personality & behavioral', d: 'Work style and culture fit', href: '#library' },
      { label: 'Language & communication', d: 'Proficiency across 16+ languages', href: '#library' },
      { label: 'Role-based tests', d: '4,500+ job-specific assessments', href: '#library' },
    ],
  },
];
...
const RES: MenuTab[] = [
  {
    ...
    subs: [
      { label: 'Blog', d: 'Hiring science, playbooks and product news', href: '#' },
      { label: 'Ebooks & guides', d: 'Deep dives on skills-based hiring', href: '#' },
      { label: 'HR glossary', d: '500+ hiring terms, defined', href: '#' },
      { label: 'Podcast', d: 'Conversations with talent leaders', href: '#' },
      { label: 'FAQ', d: 'Quick answers on plans and platform', href: '#faq' },
    ],
  },
  {
    ...
    subs: [
      { label: 'Test library', d: '3,500+ validated tests across roles', href: '#library' },
      { label: 'HR tools & calculators', d: 'Cost per hire, time to hire & more', href: '#' },
      { label: 'Job description templates', d: 'Role-ready JDs in minutes', href: '#' },
      { label: 'Interview question kits', d: 'Structured, scorable prompts', href: '#' },
      { label: 'Skills mapping', d: 'Map roles to measurable skills', href: '#' },
    ],
  },
  {
    name: 'Company',
    ...
    subs: [
      { label: 'Success stories', d: 'How 1,500+ teams hire on proof', href: '#' },
      { label: 'Integrations', d: '100+ native ATS connections', href: '#integrations' },
      { label: 'Trust center', d: 'SOC 2, ISO 27001, GDPR', href: '#security' },
      { label: 'Partners', d: 'Refer, resell or build with us', href: '#' },
      { label: 'About us', d: 'Why we built Testlify', href: '#' },
      { label: 'Careers', d: 'Join the team behind Testlify', href: '#' },
    ],
  },
];
...
export default function SiteHeader({
  ...
  const navLink = 'text-[15px] font-medium text-[#46383C] hover:text-coral transition-colors';
  const megaPanel =
    ...
    <>
      ...
      >
          ...
          <div className="max-w-[1240px] mx-auto px-7 h-[46px] flex items-center justify-between gap-[18px] text-[13px]">
            <div className="flex items-center gap-[11px] min-w-0">
              ...
              <p className="m-0 text-[#E7DADD] whitespace-nowrap overflow-hidden text-ellipsis max-[1080px]:hidden">
                {announcement}{' '}
                <a href={announcementHref} className="text-white font-semibold border-b border-white/35 pb-px whitespace-nowrap hover:border-white">
                  {announcementCta}
                </a>
              </p>
            </div>
            <div className="flex items-center gap-0.5 shrink-0">
              <a href={contactHref} className="inline-flex items-center gap-1.5 text-[#C2B1B5] px-3 py-1.5 rounded-lg font-medium hover:text-white hover:bg-white/[0.07] transition-colors whitespace-nowrap">
        ...
        <div className="max-w-[1240px] mx-auto px-7 py-4 flex items-center gap-[34px]">
          <a href="#" className="flex items-center gap-2" aria-label="Testlify home">
            <span className="text-[22px] font-extrabold tracking-[-0.5px] text-ink">Testlify</span>
          </a>
              ...
              <div className={megaPanel}>
                ...
                <div className="flex">
                  {[
                    ...
                    <div key={ci} className={`flex flex-col gap-0.5 min-w-[268px] ${ci === 0 ? 'border-r border-[#F4E4E5] pr-3.5 mr-3.5' : 'mr-3.5'}`}>
                      {col.map((id) => {
                        const g = PLAT.find((x) => x.id === id)!;
                        return (
                          <a key={g.id} href={g.href ?? '#'} className="flex items-start gap-[11px] py-[9px] px-2.5 rounded-[11px] transition-colors hover:bg-[#FFF4F3]">
                  ...
                  <div className="w-[216px] bg-gradient-to-br from-[#FFF1F0] to-[#FFE7E4] rounded-[14px] p-[18px] flex flex-col justify-center gap-[7px]">
                    ...
                    <a href="#demo" className="text-[13px] font-bold text-coral mt-1">Explore Testlify AI →</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className={megaPanel}>
                ...
                <div className="flex">
                  <div className="flex flex-col gap-0.5 min-w-[300px] pt-0.5 mr-3.5">
                    ...
                    {LIBRARY.map((g) => (
                      <a key={g.label} href={g.href} className="flex items-start gap-[11px] py-[9px] px-2.5 rounded-[11px] transition-colors hover:bg-[#FFF4F3]">
                        <span className="shrink-0 w-[34px] h-[34px] rounded-[9px] bg-rose-100 text-coral flex items-center justify-center mt-px">
                          <MegaIcon>{g.icon}</MegaIcon>
                        </span>
                        <span>
                  ...
                  <div className="w-[216px] bg-gradient-to-br from-[#FFF1F0] to-[#FFE7E4] rounded-[14px] p-[18px] flex flex-col justify-center gap-[7px]">
                    ...
                    <a href="#library" className="text-[13px] font-bold text-coral mt-1">Browse the library →</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className={megaPanel}>
                ...
                <div className="flex">
                  <div className="flex flex-col gap-0.5 min-w-[268px] border-r border-[#F4E4E5] pr-3 mr-3.5">
                    {SOL.map((g, i) => (
                      <a key={g.name} href="#solutions" onMouseEnter={() => setSolActive(i)} className={`flex items-start gap-[11px] py-[9px] px-2.5 rounded-[11px] transition-colors ${solActive === i ? 'bg-[#FFF4F3]' : 'hover:bg-[#FFF4F3]'}`}>
                        <span className="shrink-0 w-[34px] h-[34px] rounded-[9px] bg-rose-100 text-coral flex items-center justify-center mt-px">
                          <MegaIcon>{g.icon}</MegaIcon>
                        </span>
                        <span>
                  ...
                  <div className="flex flex-col gap-0.5 w-[290px] min-w-[290px] pt-0.5 mr-1.5">
                    ...
                    {S.subs.map((s) => (
                      <a key={s.label} href={s.href} className="flex flex-col gap-px py-[9px] px-3 rounded-[10px] hover:bg-rose-100 transition-colors">
                    ...
                    <a href={S.ctaHref} className="mt-1.5 text-[13px] font-bold text-coral px-3 py-2 hover:text-coral-deep">{S.cta}</a>
                  </div>
                  <div className="w-[216px] bg-gradient-to-br from-[#FFF1F0] to-[#FFE7E4] rounded-[14px] p-[18px] flex flex-col justify-center gap-[7px]">
            ...
            <div className="relative group">
              ...
              <div className={megaPanelCentered}>
                ...
                <div className="flex">
                  <div className="flex flex-col gap-0.5 min-w-[268px] border-r border-[#F4E4E5] pr-3 mr-3.5">
                    {RES.map((g, i) => (
                      <a key={g.name} href={g.ctaHref} onMouseEnter={() => setResActive(i)} className={`flex items-start gap-[11px] py-[9px] px-2.5 rounded-[11px] transition-colors ${resActive === i ? 'bg-[#FFF4F3]' : 'hover:bg-[#FFF4F3]'}`}>
                        <span className="shrink-0 w-[34px] h-[34px] rounded-[9px] bg-rose-100 text-coral flex items-center justify-center mt-px">
                          <MegaIcon>{g.icon}</MegaIcon>
                        </span>
                        <span>
                  ...
                  <div className="flex flex-col gap-0.5 w-[290px] min-w-[290px] pt-0.5 mr-1.5">
                    ...
                    <a href={R.ctaHref} className="mt-1.5 text-[13px] font-bold text-coral px-3 py-2 hover:text-coral-deep">{R.cta}</a>
                  </div>
                  <div className="w-[216px] bg-gradient-to-br from-[#FFF1F0] to-[#FFE7E4] rounded-[14px] p-[18px] flex flex-col justify-center gap-[7px]">
                    ...
                    <a href="#" className="text-[13px] font-bold text-coral mt-1">Browse free tools →</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="ml-auto flex items-center gap-5">
            ...
            <button onClick={() => setMobOpen(true)} aria-label="Open menu" className="hidden max-[900px]:inline-flex w-11 h-11 border border-[#F0E0E1] rounded-xl bg-white items-center justify-center cursor-pointer text-ink shrink-0">
      ...
      <div onClick={() => setMobOpen(false)} className={`fixed inset-0 bg-[rgba(20,8,10,0.44)] z-[1190] transition-all duration-300 min-[901px]:hidden ${mobOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`} />
      <nav aria-label="Mobile" className={`fixed top-0 right-0 bottom-0 w-[min(84vw,360px)] bg-white shadow-[-22px_0_60px_rgba(80,20,30,0.20)] z-[1200] transition-transform duration-300 pt-[74px] px-[26px] pb-[30px] overflow-y-auto min-[901px]:hidden ${mobOpen ? 'translate-x-0' : 'translate-x-[105%]'}`}>
        ...
        {[
          ...
          <a key={label} href={href} onClick={() => setMobOpen(false)} className="block text-[18px] font-semibold text-ink py-[15px] px-1.5 border-b border-[#F4E8E9] hover:text-coral">{label}</a>
        ))}
