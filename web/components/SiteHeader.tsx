...
const SOL: MenuTab[] = [
  {
    ...
    subs: [
      ...
      { label: "Logistics & supply chain", d: "Ops, warehouse & driver roles", href: "/solutions/logistics-supply-chain-industry" },
      ...
      { label: "Financial", d: "Analysts, ops & compliance", href: "/solutions/financial-industry" },
      { label: "SaaS", d: "GTM, product & engineering", href: "/solutions/saas-industry" },
      { label: "Energy", d: "Field, technical & safety roles", href: "/solutions/energy-industry" },
      ...
      { label: "Real estate", d: "Sales, ops & support roles", href: "/solutions/real-estate-industry" },
  ...
  },
  {
    ...
    subs: [
      { label: "Lateral hiring", d: "Experienced, role-specific hires", href: "/solutions/lateral-hiring" },
      { label: "Diversity and inclusion", d: "Bias-free, EEOC-defensible screening", href: "/solutions/diversity-and-inclusions" },
      { label: "Volume hiring", d: "Screen thousands in hours", href: "/solutions/volume-hiring" },
      { label: "Remote hiring", d: "Hire anywhere with proctoring", href: "/solutions/remote-hiring" },
      { label: "Blue collar hiring", d: "Practical, on-the-job skills", href: "/solutions/blue-collar-hiring" },
      { label: "Freelance hiring", d: "Vet contractors fast", href: "/solutions/freelance-hiring" },
      { label: "Campus hiring", d: "Rank graduates without resumes", href: "/solutions/campus-hiring" },
      { label: "Technical hiring", d: "45+ coding languages, live IDE", href: "/solutions/technical-hiring" },
      { label: "Sales hiring", d: "Role-plays & sales aptitude", href: "/solutions/sales-hiring" },
      { label: "Skills validation", d: "Verify skills at scale", href: "/solutions/skills-validation" },
    ],
  },
  {
    name: "By test type",
    ...
    subs: [
      { label: "Role specific", d: "4,500+ job-specific assessments", href: "/solutions/role-specific-tests" },
      { label: "Language", d: "Proficiency across 16+ languages", href: "/solutions/language-tests" },
      { label: "Programming", d: "Real-world dev challenges", href: "/solutions/programming-tests" },
      { label: "Software skills", d: "Tools & platform proficiency", href: "/solutions/software-skills-tests" },
      { label: "Personality & culture", d: "Work style & culture fit", href: "/solutions/psychometric-tests" },
      { label: "Cognitive ability", d: "Reasoning & problem-solving", href: "/solutions/cognitive-ability-tests" },
      { label: "Situational judgment", d: "Real scenario decisions", href: "/solutions/situational-judgment" },
      { label: "CEFR", d: "Standardised language levels", href: "/solutions/cefr-test" },
      { label: "Typing", d: "Speed & accuracy", href: "/solutions/typing-test" },
      { label: "Coding", d: "Live coding, 45+ languages", href: "/solutions/coding-tests" },
      { label: "Engineering", d: "Applied engineering skills", href: "/solutions/engineering-skills" },
    ],
  },
  {
    ...
    subs: [
      { label: "For startups", d: "Hire fast without a TA team", href: "/solutions/for-startups" },
      { label: "SMB's", d: "Standardize hiring as you scale", href: "/solutions/small-medium-businesses" },
      { label: "Enterprises", d: "SSO, compliance & audit trails", href: "/solutions/enterprise" },
      { label: "Non-profits", d: "Fair, defensible selection", href: "/solutions/non-profits" },
      { label: "Public sector", d: "Transparent, auditable hiring", href: "/solutions/public-sector-talent-assessment-solution" },
    ],
  },
];
