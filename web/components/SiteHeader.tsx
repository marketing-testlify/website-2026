...
const SOL: MenuTab[] = [
  {
    ...
    subs: [
      { label: "Information & technology", d: "Developers, DevOps, data & security", href: "/it-industry" },
      { label: "Logistics & supply chain", d: "Ops, warehouse & driver roles", href: "/logistics-supply-chain-industry" },
      { label: "Retail", d: "High-volume frontline hiring", href: "/retail-industry" },
      { label: "Recruitment", d: "Agency & in-house recruiters", href: "/recruitment-industry" },
      { label: "Financial", d: "Analysts, ops & compliance", href: "/financial-industry" },
      { label: "SaaS", d: "GTM, product & engineering", href: "/saas-industry" },
      { label: "Energy", d: "Field, technical & safety roles", href: "/energy-industry" },
      { label: "Hospitality", d: "Service & front-of-house teams", href: "/hospitality-industry" },
      { label: "Health care", d: "Clinical & administrative screening", href: "/health-care-industry" },
      { label: "BPO", d: "Multilingual, high-ramp hiring", href: "/bpo-industry" },
      { label: "Edtech", d: "Educators & product teams", href: "/edtech-industry" },
      { label: "Real estate", d: "Sales, ops & support roles", href: "/real-estate-industry" },
      { label: "Media", d: "Creative, editorial & production", href: "/media-industry" },
    ],
  },
  {
    name: "By use case",
    ...
    subs: [
      { label: "Lateral hiring", d: "Experienced, role-specific hires", href: "/lateral-hiring" },
      { label: "Diversity and inclusion", d: "Bias-free, EEOC-defensible screening", href: "/diversity-and-inclusions" },
      { label: "Volume hiring", d: "Screen thousands in hours", href: "/volume-hiring" },
      { label: "Remote hiring", d: "Hire anywhere with proctoring", href: "/remote-hiring" },
      { label: "Blue collar hiring", d: "Practical, on-the-job skills", href: "/blue-collar-hiring" },
      { label: "Freelance hiring", d: "Vet contractors fast", href: "/freelance-hiring" },
      { label: "Campus hiring", d: "Rank graduates without resumes", href: "/campus-hiring" },
      { label: "Technical hiring", d: "45+ coding languages, live IDE", href: "/technical-hiring" },
      { label: "Sales hiring", d: "Role-plays & sales aptitude", href: "/sales-hiring" },
      { label: "Skills validation", d: "Verify skills at scale", href: "/skills-validation" },
    ],
  },
  {
    name: "By test type",
    ...
    subs: [
      { label: "Role specific", d: "4,500+ job-specific assessments", href: "/role-specific-tests" },
      { label: "Language", d: "Proficiency across 16+ languages", href: "/language-tests" },
      { label: "Programming", d: "Real-world dev challenges", href: "/programming-tests" },
      { label: "Software skills", d: "Tools & platform proficiency", href: "/software-skills-tests" },
      { label: "Personality & culture", d: "Work style & culture fit", href: "/psychometric-tests" },
      { label: "Cognitive ability", d: "Reasoning & problem-solving", href: "/cognitive-ability-tests" },
      { label: "Situational judgment", d: "Real scenario decisions", href: "/situational-judgment" },
      { label: "CEFR", d: "Standardised language levels", href: "/cefr-test" },
      { label: "Typing", d: "Speed & accuracy", href: "/typing-test" },
      { label: "Coding", d: "Live coding, 45+ languages", href: "/coding-tests" },
      { label: "Engineering", d: "Applied engineering skills", href: "/engineering-skills" },
    ],
  },
  {
    ...
    subs: [
      { label: "For startups", d: "Hire fast without a TA team", href: "/for-startups" },
      { label: "SMB's", d: "Standardize hiring as you scale", href: "/small-medium-businesses" },
      { label: "Enterprises", d: "SSO, compliance & audit trails", href: routes.solutions },
      { label: "Non-profits", d: "Fair, defensible selection", href: "/non-profits" },
      { label: "Public sector", d: "Transparent, auditable hiring", href: "/public-sector-talent-assessment-solution" },
    ],
  },
];
...
const MOBILE_SECTIONS: MobileSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "By test type", d: "Coding, cognitive, personality & more", href: "/coding-tests" },
