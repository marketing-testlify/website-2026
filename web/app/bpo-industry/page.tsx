    ...
    <>
      ...
      <section className="tsd-hero" data-screen-label="Hero"><div className="tsdw tsd-hgrid">
        <div className="tsd-copy reveal">
          <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Industry / BPO</span></div>
          <p className="eyebrow">For BPO teams<b>.</b></p>
          <h1 className="tsd-h1">Find top talent with Testlify in the <span style={{ color: '#F23F44' }}>BPO industry</span></h1>
          <p className="tsd-lead">As a recruiter in the BPO industry, you know the importance of finding the right candidate for the job. Hiring the wrong person can be a costly mistake that can impact your business&rsquo;s productivity and reputation. That&rsquo;s where Testlify comes in.</p>
          <div className="tsd-stats">
            <span className="tsd-statc">3,500+ validated tests</span>
            <span className="tsd-statc">Comms &amp; aptitude tests</span>
            <span className="tsd-statc">16+ languages</span>
          </div>
        ...
        <div className="tsd-media"><div className="ithero-wrap">
          <div className="ithero-card">
            ...
            <div className="rt-cand"><span className="rt-av">RP</span><div className="rt-ci"><span className="rt-nm">Rina Patel</span><span className="rt-role">Customer Support · BPO</span></div><span className="rt-fit">Role-ready</span></div>
            <div className="ithero-scores">
              <div className="ithero-scr"><span className="ithero-scl">Communication</span><span className="ithero-scbar"><i style={{ '--w': '93%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">93</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Customer service</span><span className="ithero-scbar"><i style={{ '--w': '90%', animationDelay: '.3s' } as React.CSSProperties}></i></span><span className="ithero-scv">90</span></div>
              ...
              <div className="ithero-scr"><span className="ithero-scl">Computer literacy</span><span className="ithero-scbar"><i style={{ '--w': '82%', animationDelay: '.6s' } as React.CSSProperties}></i></span><span className="ithero-scv">82</span></div>
            </div>
          </div>
      ...
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Get targeted insights about your candidates</h2>
            <p className="tsd-p">Our BPO industry assessments are tailored to give you relevant insights about your candidates. We understand each industry has unique requirements, and our tests cover a range of competencies essential for success in BPO.</p>
            <p className="tsd-p">Assessments cover communication skills, problem-solving, analytical abilities and more — so you get the most relevant information about your candidates and make informed hiring decisions.</p>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/10/Get-targeted-insights-about-your-candidates-1024x1024.png")' }}></div></div></div>
        </div>
      </div></section>
      ...
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Create your own pre-hiring assessments with ease</h2>
            <p className="tsd-p">Creating pre-hiring assessments for the BPO industry has never been easier. Our user-friendly platform lets you create and customize assessments to fit your specific hiring needs.</p>
            <p className="tsd-p">Choose from a range of question types to evaluate candidates&rsquo; knowledge, cognitive abilities and behavioral traits. Say goodbye to time-consuming, expensive traditional hiring and streamline your process with Testlify.</p>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/09/Create-your-own-pre-hiring-assessments-with-ease.png")' }}></div></div></div>
        </div>
      </div></section>

      {/* Section 3 — split, sand */}
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Why choose Testlify for hiring in the BPO industry?</h2>
            <p className="tsd-p">Our assessments are tailored to the unique needs of the BPO industry, ensuring you hire the most qualified candidates for your organization.</p>
            <div className="tsd-bl tsd-bl1">
              {['Vast library of pre-built tests', 'Customizable assessments', 'Accurate assessment of candidates’ skills', 'Quick and easy setup', 'Time and cost-effective'].map((b, i) => (
                <div className="tsd-bi" key={i}>{CHECK}<span className="tsd-bt">{b}</span></div>
              ))}
            </div>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/10/Why-choose-Testlify-for-hiring-in-the-BPO-industry-1.png")' }}></div></div></div>
        </div>
      </div></section>

      {/* Section 4 — split, flip, white */}
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Effortlessly manage candidates with Testlify&rsquo;s ATS integration</h2>
            <p className="tsd-p">Simplify your hiring process with Testlify&rsquo;s ATS integration, which seamlessly merges our talent assessments with your ATS. Streamline candidate management and focus on what matters most — finding the right talent for your team.</p>
            <Link className="tsd-link" href="/test-library">View our test library{ARROW}</Link>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/09/Effortlessly-manage-candidates-with-Testlifys-ATS-integration.png")' }}></div></div></div>
        </div>
      </div></section>

      {/* Section 5 — split, sand */}
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Expansive hiring process for the BPO industry</h2>
            <p className="tsd-p">Everything you need to run a fair, reliable BPO hiring process at scale.</p>
            <div className="tsd-bl tsd-bl1">
              {['A comprehensive test library with a wide range of assessments', 'Customizable assessments tailored to your specific needs', 'Easy-to-use platform to manage candidates and track progress', 'Reliable results that accurately measure candidate performance', 'Unbiased assessments that ensure a fair selection process'].map((b, i) => (
                <div className="tsd-bi" key={i}>{CHECK}<span className="tsd-bt">{b}</span></div>
              ))}
            </div>
            <Link className="tsd-link" href="/pricing">Try for free{ARROW}</Link>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/10/Expansive-hiring-process-for-the-BPO-industry-1-1024x1024.png")' }}></div></div></div>
        </div>
      </div></section>

      {/* Section 6 — bullets, white */}
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <p className="eyebrow">Test coverage<b>.</b></p>
            <h2 className="tsd-h2">Accurate insights into candidates&rsquo; skills and aptitudes</h2>
          ...
          <div className="tsd-copy reveal">
            <div className="tsd-bl tsd-bl1">
              {['Communication Skills', 'Customer support', 'Time Management', 'Teamwork', 'Problem solving', 'Customer Service'].map((b, i) => (
                <div className="tsd-bi" key={i}>{CHECK}<span className="tsd-bt">{b}</span></div>
              ))}
            </div>
          </div>
      ...
      <Testimonials eyebrow="Testimonials" heading="What BPO and contact-center teams say about skills-based hiring" />
