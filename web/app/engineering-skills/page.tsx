...
const stats = ['Multi-discipline', 'Hands-on challenges', 'Anti-cheat & GDPR'];
...
export default function EngineeringSkillsPage() {
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">OH</span><div className="rt-ci"><span className="rt-nm">Omar Hassan</span><span className="rt-role">Mechanical Engineer · Engineering</span></div><span className="rt-fit">Strong hire</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Technical knowledge</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '92%', animationDelay: '.15s' }}></i></span><span className="ithero-scv">92</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Problem solving</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '89%', animationDelay: '.3s' }}></i></span><span className="ithero-scv">89</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Circuit &amp; design</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' }}></i></span><span className="ithero-scv">85</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Safety</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' }}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
