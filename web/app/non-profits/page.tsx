        ...
        <div className="tsdw tsd-hgrid">
          <div className="tsd-copy reveal">
            ...
            <div className="tsd-stats">
              ...
              <span className="tsd-statc">Full assessment access</span>
              <span className="tsd-statc">Mission-aligned hiring</span>
            </div>
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">GA</span><div className="rt-ci"><span className="rt-nm">Grace Adeyemi</span><span className="rt-role">Program Coordinator · Non-profit</span></div><span className="rt-fit">Mission-aligned</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Mission fit</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '93%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">93</span></div>
                  ...
                  <div className="ithero-scr"><span className="ithero-scl">Resourcefulness</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' } as React.CSSProperties}></i></span><span className="ithero-scv">85</span></div>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-grid2 tsd-flip">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Customized skills assessment for non-profit organizations</h2>
              <p className="tsd-p">Unlock tailored success with tests crafted for nonprofit organizations — and create and customize your own. Harness sector-specific insights to cultivate mission-aligned skills for strategic talent development.</p>
              <div className="tsd-bl">
                {['Sector-specific evaluations', 'Customized competency testing', 'Mission-aligned skill metrics', 'Strategic talent development'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
            </div>
