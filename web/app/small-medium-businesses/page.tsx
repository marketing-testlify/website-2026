...
export default function SmallMediumBusinessesPage() {
  ...
  return (
    <>
      ...
      <section className="tsd-hero">
        <div className="tsdw tsd-hgrid">
          <div className="tsd-copy reveal">
            <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Company size / SMBs</span></div>
            <p className="eyebrow">For SMBs<b>.</b></p>
            <h1 className="tsd-h1">Smart skills assessments for <span className="tac">SMBs</span></h1>
            <p className="tsd-lead">Make faster, bias-free hiring decisions with expertly designed assessments tailored for small and growing businesses. Testlify is built for the agility and speed SMBs need without compromising on quality — identify top talent with ready-to-use tests, automated workflows and instant insights.</p>
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">TW</span><div className="rt-ci"><span className="rt-nm">Tom Wallace</span><span className="rt-role">Office Manager hire · SMB</span></div><span className="rt-fit">Great fit</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Versatility</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '90%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">90</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Communication</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '88%', animationDelay: '.3s' } as React.CSSProperties}></i></span><span className="ithero-scv">88</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Reliability</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' } as React.CSSProperties}></i></span><span className="ithero-scv">85</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Tech literacy</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' } as React.CSSProperties}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
      ...
      <section className="tsd-sec">
        <div className="tsdw">
          <div className="tsd-grid2">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">One platform. Every skill you need</h2>
              <p className="tsd-p">Whether you&apos;re hiring a marketing generalist, sales associate, developer or customer support rep, we&apos;ve got you covered.</p>
              <div className="tsd-bl">
                {['3,000+ pre-built tests', 'Role-specific & industry-based', 'Regularly updated by experts', 'Soft skills, technical, cognitive & behavioral'].map((b, i) => (
      ...
      {/* Section 1 — cards (sand) */}
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-shead reveal">
            <p className="eyebrow">Backed by data<b>.</b></p>
            <h2 className="tsd-h2">Make decisions backed by data</h2>
            <p className="tsd-lead">In-depth analytics on every test — compare candidates fairly and avoid bad hires.</p>
          </div>
      ...
      {/* Section 2 — split (white, flip) */}
      <section className="tsd-sec">
        <div className="tsdw">
          <div className="tsd-grid2 tsd-flip">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">A better experience for candidates too</h2>
              <p className="tsd-p">Keep top talent engaged with short, relevant, branded assessments that feel like an extension of your company culture.</p>
              <div className="tsd-bl">
                {['Mobile-friendly assessments', 'Timed tests', 'Custom welcome messages & branding'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
            </div>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-shead reveal">
            <p className="eyebrow">Built for you<b>.</b></p>
            <h2 className="tsd-h2">Built for teams that need results now</h2>
            <p className="tsd-lead">No HR department? No problem — anyone can launch tests in minutes.</p>
          </div>
          <div className="tsd-cards">
            {[
              { title: 'Drag-and-drop test creation', icon: 'M5 9 2 12l3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20', desc: 'Intuitive design means founders, office managers and team leads can build tests fast.' },
              { title: '100+ ATS integrations', icon: 'M10 13a5 5 0 0 0 7 0l3-3a5 5 0 0 0-7-7l-1 1M14 11a5 5 0 0 0-7 0l-3 3a5 5 0 0 0 7 7l1-1', desc: 'Works out of the box with your existing tools and recruitment workflow.' },
              { title: 'Anti-cheat & proctoring', icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z', desc: 'Built-in proctoring and anti-cheating keep every assessment fair and secure.' },
            ].map((c, i) => (
              <div className="tsd-card reveal" key={i}>
                <div className="tsd-ic"><CardIcon d={c.icon} /></div>
                <p className="tsd-ct">{c.title}</p>
