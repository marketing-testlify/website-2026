...
/**
 * Accordion — powers the "Inside the interview" and FAQ sections on the
 * interview-detail page. Ported from the prototype's `.acc`/`.ai`/`.ah`/`.ab`
      ...
      {items.map((it, i) => {
        ...
        return (
          ...
          >
            ...
            {isOpen && (
              <div className={`${it.num ? "pl-[67px] pr-[22px] pb-[22px]" : "px-[22px] pb-[22px]"}`}>
                {it.content}
              </div>
            )}
          </div>
