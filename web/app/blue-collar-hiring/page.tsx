...
export default function BlueCollarHiringPage() {
    ...
    <>
      ...
      <section className="tsd-hero" data-screen-label="Hero"><div className="tsdw tsd-hgrid">
        <div className="tsd-copy reveal">
          <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Use case / Blue collar hiring</span></div>
          <p className="eyebrow">For blue-collar hiring<b>.</b></p>
          <h1 className="tsd-h1">Best skills assessments for <span className="tac">blue-collar hiring</span></h1>
          <p className="tsd-lead">Test real-world skills before you hire — from electricians to machine operators. Testlify&apos;s blue-collar hiring tests give you a comprehensive library to assess both the hard and soft skills of blue-collar workers, easily.</p>
        ...
        <div className="tsd-media"><div className="ithero-wrap">
          <div className="ithero-card">
            ...
            <div className="rt-cand"><span className="rt-av">TB</span><div className="rt-ci"><span className="rt-nm">Tom Becker</span><span className="rt-role">Machine Operator · Blue collar</span></div><span className="rt-fit">Floor-ready</span></div>
            <div className="ithero-scores">
              <div className="ithero-scr"><span className="ithero-scl">Technical skill</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '92%', animationDelay: '.15s' }}></i></span><span className="ithero-scv">92</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Safety knowledge</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '90%', animationDelay: '.3s' }}></i></span><span className="ithero-scv">90</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Hand-eye coordination</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' }}></i></span><span className="ithero-scv">85</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Follows instructions</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' }}></i></span><span className="ithero-scv">82</span></div>
            </div>
          </div>
