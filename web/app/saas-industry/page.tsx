...
.fin-cards2{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:46px;}
.fin-lcard{background:#fff;border:1px solid #F0E2E3;border-radius:18px;padding:30px 30px;box-shadow:0 16px 30px rgba(110,11,14,.08);transition:transform .3s cubic-bezier(.2,.7,.3,1),border-color .3s,box-shadow .3s;}
.fin-lcard:hover{transform:translateY(-4px);border-color:#FBD0D1;box-shadow:0 22px 44px rgba(110,11,14,.12);}
.fin-lcard h3{font-size:19px;font-weight:700;margin:0;letter-spacing:-.3px;line-height:1.28;}
.fin-lcard .rt-chk{margin-top:18px;}
...
.rt-role-link{position:absolute;inset:0;z-index:2;border-radius:18px;}
...
@media(max-width:960px){.rt-hgrid,.rt-g2{grid-template-columns:1fr;gap:40px;}.rt-flip .rt-copy{order:1;}.statrow{grid-template-columns:1fr 1fr;row-gap:34px;}.statrow3{grid-template-columns:1fr 1fr;}.stat + .stat{border-left:none;}.rt-roles,.fin-cards2,.sa-vs,.sat-grid{grid-template-columns:1fr;}.rt-ats{grid-template-columns:repeat(3,1fr);}.rt-h1{font-size:38px;}.rt-h2{font-size:27px;}.rtsec{padding:64px 0;}}
    ...
    <>
      ...
      <section className="rt-hero" data-screen-label="Hero"><div className="rtw rt-hgrid">
        <div className="rt-copy reveal">
          <div className="rt-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Industry / SaaS</span></div>
          <p className="eyebrow">For SaaS teams<b>.</b></p>
          <h1 className="rt-h1">Screen every SaaS role on real skills. Hire people who <span style={{ color: '#F23F44' }}>ramp, ship, and retain</span></h1>
          <p className="rt-lead">Test sales aptitude, live coding, and role-specific skills before the first interview. One platform. Every SaaS function. Ranked shortlist.</p>
        ...
        <div className="rt-media reveal">
          <div className="fin-hero-card">
            <div className="fin-pipe">
              ...
              <div className="fin-node"><span className="fin-dot"><i></i></span><span>Interview</span></div>
            ...
            <div className="fin-score">
              ...
              <div className="rt-scores">
                <div className="rt-scr"><span className="rt-scl">Sales aptitude</span><span className="rt-scbar"><i style={{ '--w': '96%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="rt-scv">96</span></div>
                <div className="rt-scr"><span className="rt-scl">Product knowledge</span><span className="rt-scbar"><i style={{ '--w': '87%', animationDelay: '.28s' } as React.CSSProperties}></i></span><span className="rt-scv">87</span></div>
                <div className="rt-scr"><span className="rt-scl">Coding</span><span className="rt-scbar"><i style={{ '--w': '88%', animationDelay: '.41s' } as React.CSSProperties}></i></span><span className="rt-scv">88</span></div>
                <div className="rt-scr"><span className="rt-scl">Communication</span><span className="rt-scbar"><i style={{ '--w': '77%', animationDelay: '.54s' } as React.CSSProperties}></i></span><span className="rt-scv">77</span></div>
                <div className="rt-scr"><span className="rt-scl">Cognitive</span><span className="rt-scbar"><i style={{ '--w': '86%', animationDelay: '.67s' } as React.CSSProperties}></i></span><span className="rt-scv">86</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="rtsec rtsand" style={{ paddingTop: '44px', paddingBottom: '44px' }}><div className="rtw">
        <div className="statrow statrow3 reveal">
          <div className="stat"><div className="statn"><span className="v" ref={c1}>0</span><span className="u">+</span></div><div className="statl">SaaS and tech roles you can assess</div></div>
          ...
          <div className="stat"><div className="statn"><span className="v" ref={c3}>0</span><span className="u">+</span></div><div className="statl">Programming languages tested</div></div>
        </div>
      </div></section>

      <section className="rtsec"><div className="rtw">
        <div className="rt-shead reveal"><p className="eyebrow">The stakes<b>.</b></p><h2 className="rt-h2">Resumes can't tell you who will actually perform</h2><p className="rt-lead">SaaS hiring is fast, expensive, and unforgiving. Getting the SaaS pre-employment test wrong costs a full quarter. The cost of guessing wrong is a lost quarter.</p></div>
        <div className="sa-vs reveal">
          <div className="sa-vscol sa-bad">
            <div className="sa-vshead"><span className="sa-vsicon" style={{ background: '#F0E4E5', color: '#8A7A7D' }}>✕</span><span className="sa-vstag" style={{ color: '#8A7A7D' }}>The hiring gamble</span></div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#EADDDE', color: '#8A7A7D' }}>✕</span>SaaS reps take 5.7 months to ramp and roughly 3x base salary to get there.</div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#EADDDE', color: '#8A7A7D' }}>✕</span>Only about half of AEs hit quota, and interviews rarely predict who will.</div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#EADDDE', color: '#8A7A7D' }}>✕</span>You hire GTM and engineering at once, two completely different bars.</div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#EADDDE', color: '#8A7A7D' }}>✕</span>A wrong hire costs a full quarter of missed pipeline or shipped features.</div>
          </div>
          <div className="sa-vscol sa-good">
            <div className="sa-vshead"><span className="sa-vsicon" style={{ background: '#F23F44', color: '#fff' }}>✓</span><span className="sa-vstag" style={{ color: '#F23F44' }}>Skills-based hiring with Testlify</span></div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#F23F44', color: '#fff' }}>✓</span>Verify selling, technical, and role skills with a GTM hiring assessment before the offer.</div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#F23F44', color: '#fff' }}>✓</span>Hire on proven ability, so more reps ramp fast and hit quota.</div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#F23F44', color: '#fff' }}>✓</span>One platform screens every function — GTM, product, and engineering — to the right bar.</div>
            <div className="sa-vsi"><span className="sa-vsmark" style={{ background: '#F23F44', color: '#fff' }}>✓</span>Ranked shortlist in hours, with a documented, defensible score behind every decision.</div>
          </div>
        </div>
      </div></section>

      <section className="rtsec rtsand"><div className="rtw">
        <div className="rt-shead reveal"><p className="eyebrow">SaaS roles<b>.</b></p><h2 className="rt-h2">Assess every SaaS role with the right test</h2><p className="rt-lead">From SDRs to senior engineers, Testlify's SaaS hiring assessment covers every role with validated skills tests on one platform.</p></div>
        <div className="rt-roles reveal">
          <div className="rt-role">
            <div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><line x1="23" y1="6" x2="13.5" y2="15.5"></line><polyline points="23 6 23 11 18 11"></polyline><line x1="1" y1="20" x2="10" y2="11"></line></svg></span></div>
            <h3>Reps who can sell</h3><p className="rt-role-d">SDRs, AEs, and account managers.</p>
            <div className="rt-tags"><span className="rt-tag">SJT</span><span className="rt-tag">Discovery</span><span className="rt-tag">Sales aptitude</span></div>
          </div>
          <div className="rt-role">
            ...
            <h3>CS and support</h3><p className="rt-role-d">CSMs, support, and onboarding specialists.</p>
            <div className="rt-tags"><span className="rt-tag">Communication</span><span className="rt-tag">Problem-solving</span><span className="rt-tag">Empathy</span></div>
          </div>
          <div className="rt-role">
            ...
            <h3>PM and design talent</h3><p className="rt-role-d">Product managers, product ops, and UX or UI.</p>
            <div className="rt-tags"><span className="rt-tag">Cognitive</span><span className="rt-tag">Role-specific</span><span className="rt-tag">Software skills</span></div>
          </div>
          <div className="rt-role">
            <div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg></span></div>
            <h3>Builders who ship</h3><p className="rt-role-d">Frontend, backend, full-stack, and DevOps.</p>
            <div className="rt-tags"><span className="rt-tag">Coding</span><span className="rt-tag">Engineering</span><span className="rt-tag">System design</span></div>
          </div>
          <div className="rt-role">
            <div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11l18-5v12L3 14v-3z"></path><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"></path></svg></span></div>
            <h3>Demand and operations</h3><p className="rt-role-d">Marketers, growth, and revenue operations.</p>
            <div className="rt-tags"><span className="rt-tag">Marketing</span><span className="rt-tag">Analytics</span><span className="rt-tag">Tools</span></div>
          </div>
          <div className="rt-role">
            <div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5v14a9 3 0 0 0 18 0V5"></path><path d="M3 12a9 3 0 0 0 18 0"></path></svg></span></div>
            <h3>Analysts and scientists</h3><p className="rt-role-d">Data analysts, data engineers, and scientists.</p>
            <div className="rt-tags"><span className="rt-tag">SQL</span><span className="rt-tag">Data analysis</span><span className="rt-tag">Reasoning</span></div>
          </div>
        </div>
      ...
      <section className="rtsec"><div className="rtw">
        <div className="rt-shead reveal"><p className="eyebrow">The platform<b>.</b></p><h2 className="rt-h2">The SaaS skills tests that predict who ramps, ships, and stays</h2><p className="rt-lead">Most assessments test theory. Testlify tests what SaaS roles actually demand. From discovery calls to shipping code, every assessment is built around real on-the-job performance signals.</p></div>
        <div className="rt-g2" style={{ marginTop: '56px' }}>
          <div className="rt-copy reveal">
            ...
            <div className="rt-chk">
              <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Sales aptitude, discovery skills, and situational judgment</div>
              <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>SaaS-specific scenarios: demos, objections, multi-stakeholder deals</div>
              <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Covers SDRs, AEs, CSMs, and account management roles</div>
              <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Ranked shortlist before your first screen call</div>
            </div>
          </div>
          <div className="rt-media reveal">
            <div className="fin-card">
              <div className="fin-card-bar"><span className="fin-dots"><i style={{ background: '#F26B6B' }}></i><i style={{ background: '#F5B93F' }}></i><i style={{ background: '#4CC38A' }}></i></span><span className="fin-card-t">Assessment results · Senior AE · 18 candidates</span></div>
              <div className="fin-card-b">
                ...
                <div className="sa-bd">
                  ...
                  <div className="sa-bd-row"><span>Discovery questioning</span><span className="v">94%</span></div><div className="sa-bd-bar"><i style={{ width: '94%' }}></i></div>
                  <div className="sa-bd-row"><span>Sales aptitude</span><span className="v">89%</span></div><div className="sa-bd-bar" style={{ marginBottom: 0 }}><i style={{ width: '89%' }}></i></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="rtsec rtsand"><div className="rtw rt-g2 rt-flip">
        <div className="rt-copy reveal">
          ...
          <div className="rt-chk">
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Live coding in 45+ programming languages</div>
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>System design, debugging, and code review challenges</div>
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Frontend, backend, full-stack, and DevOps roles covered</div>
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>AI-scored with detailed per-skill breakdown</div>
          </div>
        </div>
        <div className="rt-media reveal">
          <div className="fin-card">
            <div className="fin-card-bar"><span className="fin-dots"><i style={{ background: '#F26B6B' }}></i><i style={{ background: '#F5B93F' }}></i><i style={{ background: '#4CC38A' }}></i></span><span className="fin-card-t">Live coding · Senior Backend Engineer · Python</span></div>
            <div className="fin-card-b">
<pre className="sa-code"><span className="c"># Fix the bug in this rate limiter</span>{'\n'}<span className="k">def</span> <span className="fn">check_rate_limit</span>(user_id, limit=<span className="n">100</span>):{'\n'}    key = <span className="s">f&quot;rate:&#123;user_id&#125;&quot;</span>{'\n'}    count = redis.get(key) <span className="k">or</span> <span className="n">0</span>{'\n'}    <span className="k">if</span> count &gt;= limit:{'\n'}        <span className="k">return</span> <span className="n">False</span>{'\n'}    redis.incr(key){'\n'}    <span className="c"># Bug: expiry never set</span>{'\n'}    <span className="k">return</span> <span className="n">True</span></pre>
      ...
      <section className="rtsec"><div className="rtw rt-g2">
        <div className="rt-copy reveal">
          ...
          <div className="rt-chk">
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>SaaS pre-employment tests for every function in one platform</div>
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Consistent scoring criteria across all roles and hiring managers</div>
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>100+ ATS integrations so results live in your existing workflow</div>
            <div className="rt-ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Audit-ready records for every hiring decision</div>
          </div>
        </div>
        <div className="rt-media reveal">
          <div className="fin-card">
            <div className="fin-card-bar"><span className="fin-dots"><i style={{ background: '#F26B6B' }}></i><i style={{ background: '#F5B93F' }}></i><i style={{ background: '#4CC38A' }}></i></span><span className="fin-card-t">Assessments · Q3 hiring · All functions</span></div>
            <div className="fin-card-b">
      ...
      <section className="rtsec rtsand"><div className="rtw">
        <div className="rt-shead reveal"><p className="eyebrow">Why Testlify<b>.</b></p><h2 className="rt-h2">A better way than how most SaaS teams hire</h2></div>
      ...
      <section className="rtsec"><div className="rtw">
        <div className="rt-shead reveal" style={{ textAlign: 'left', maxWidth: 'none' }}><h2 className="rt-h2" style={{ fontSize: '44px' }}>What SaaS hiring teams say about skills-based hiring</h2></div>
        <div className="sat-grid reveal">
          <div className="sat-card">
            <div className="sat-stars">{star}{star}{star}{star}{star}</div>
            <p className="sat-q">“We screen sales aptitude and engineering skills on one platform now, which sped up hiring and cut early attrition on the GTM team.”</p>
          ...
          <div className="sat-card">
            <div className="sat-stars">{star}{star}{star}{star}{star}</div>
            <p className="sat-q">“During a growth push we screened hundreds of candidates a month without dropping our quality bar or adding recruiters.”</p>
