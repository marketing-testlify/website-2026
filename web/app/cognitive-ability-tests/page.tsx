      ...
      <section className="tsd-hero">
        <div className="tsdw tsd-hgrid">
          <div className="tsd-copy reveal">
            <div className="tsd-crumb"><Link href="/solutions">Solutions</Link><span>/</span><span>Test type / Cognitive ability</span></div>
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">RM</span><div className="rt-ci"><span className="rt-nm">Ravi Menon</span><span className="rt-role">Analyst · High potential</span></div><span className="rt-fit">Top 10%</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Numerical reasoning</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '93%', animationDelay: '.15s' }}></i></span><span className="ithero-scv">93</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Logical reasoning</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '90%', animationDelay: '.3s' }}></i></span><span className="ithero-scv">90</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Verbal reasoning</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' }}></i></span><span className="ithero-scv">85</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Problem solving</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '83%', animationDelay: '.6s' }}></i></span><span className="ithero-scv">83</span></div>
                </div>
              </div>
        ...
        <div className="tsdw">
          ...
          <div className="tsd-marq-wrap">
            <div className="tsd-marq">
              <span className="tsd-marq-i">LTIMindtree</span><span className="tsd-marq-i">Sonatafy</span><span className="tsd-marq-i">Thales</span><span className="tsd-marq-i">Third Bridge</span><span className="tsd-marq-i">Virtual</span><span className="tsd-marq-i">Cogitotech</span>
              <span className="tsd-marq-i">LTIMindtree</span><span className="tsd-marq-i">Sonatafy</span><span className="tsd-marq-i">Thales</span><span className="tsd-marq-i">Third Bridge</span><span className="tsd-marq-i">Virtual</span><span className="tsd-marq-i">Cogitotech</span>
            </div>
          </div>
        </div>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          ...
          <div className="tsd-faqw">
            {faqs.map((f, i) => (
              <div key={i} className={`tsd-faq reveal ${open[i] ? 'tsd-open' : ''}`} onClick={() => toggleFaq(i)}>
