...
export default function LanguageTestsPage() {
  ...
  return (
    <>
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">YT</span><div className="rt-ci"><span className="rt-nm">Yuki Tanaka</span><span className="rt-role">Support Lead · Multilingual</span></div><span className="rt-fit">C1 fluent</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Speaking</span><span className="ithero-scbar"><i style={{ '--w': '92%', animationDelay: '.15s' } as React.CSSProperties} /></span><span className="ithero-scv">92</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Listening</span><span className="ithero-scbar"><i style={{ '--w': '90%', animationDelay: '.3s' } as React.CSSProperties} /></span><span className="ithero-scv">90</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Reading</span><span className="ithero-scbar"><i style={{ '--w': '86%', animationDelay: '.45s' } as React.CSSProperties} /></span><span className="ithero-scv">86</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Writing</span><span className="ithero-scbar"><i style={{ '--w': '83%', animationDelay: '.6s' } as React.CSSProperties} /></span><span className="ithero-scv">83</span></div>
                </div>
              </div>
      ...
      {sections.map((s, i) => (
        <section key={i} className={`tsd-sec ${s.sand ? 'tsd-sand' : ''}`}>
          <div className="tsdw">
            <div className={`tsd-grid2 ${s.flip ? 'tsd-flip' : ''}`}>
              <div className="tsd-copy reveal">
                ...
                <div className="tsd-bl">
                  {s.bullets.map((b, bi) => (
                    <div key={bi} className="tsd-bi"><CheckSm /><span className="tsd-bt">{b}</span></div>
                  ))}
                </div>
                {s.cta && (
                  <Link className="tsd-link" href={s.cta.href}>{s.cta.label}<ArrowRt /></Link>
                )}
              </div>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          ...
          <div className="itats-more reveal"><Link href="/integrations">View all ATS integrations<ArrowRt /></Link></div>
        </div>
      </section>
