...
export default function PlayrollPage() {
  return (
    <>
...
` }} />
      ...
      <SiteHeader announcement="See how Playroll cut cost per hire by 44%" />

      <section className="cs-hero"><div className="wrap">
        <p className="cs-crumb reveal in"><Link href="/customer-success-stories">Customers</Link><span className="sep">›</span><span>HR &amp; payroll</span><span className="sep">›</span><span>Playroll</span></p>
        <div className="cs-logo reveal in"></div>
        <h1 className="cs-h1 reveal in">How Playroll scaled global hiring without lowering the bar</h1>
        <p className="cs-sub reveal in">Playroll helps companies employ talent worldwide. To hire across borders consistently, they standardised screening on Testlify.</p>
        <div className="cs-metrics reveal in">
          <div className="cs-metric"><div className="n">44%</div><div className="l">lower cost per hire</div></div>
          <div className="cs-metric"><div className="n">2.5×</div><div className="l">more qualified shortlists</div></div>
          <div className="cs-metric"><div className="n">95%</div><div className="l">assessment completion</div></div>
        </div>
      </div></section>
        ...
        <div className="cs-body">
          <div>
            <div className="cs-block reveal"><h2>The challenge</h2>
              <p>Hiring across many countries meant inconsistent screening standards and language barriers that filtered out strong candidates for the wrong reasons.</p>
              <p>Playroll needed one fair, consistent bar for every region — and the compliance trail to back it up.</p>
            </div>
            <div className="cs-block reveal"><h2>The solution</h2>
              <p>Playroll standardised on Testlify assessments, using multilingual support so candidates test in their own language, and structured scoring for consistency across regions.</p>
              <p>The AI resume screener ranks applicants against the same skill profile everywhere, giving recruiters one comparable shortlist per role.</p>
            </div>
            <div className="cs-quote reveal">
              <p>“One consistent, fair bar across every country — with the audit trail our compliance team needs. Testlify made global hiring simpler.”</p>
              <div className="cs-qby"><span className="cs-qav"></span><span><span className="cs-qn">People Team</span><br /><span className="cs-qr">Playroll</span></span></div>
            </div>
            <div className="cs-block reveal"><h2>The results</h2>
              <p>Cost per hire fell 44% as agency reliance dropped and shortlists got sharper — 2.5× more candidates cleared later stages. Completion hit 95%.</p>
              <p>Playroll now hires across borders with one defensible standard, and candidates everywhere get an equal shot.</p>
            </div>
          </div>
          <aside className="cs-card reveal">
            <h3>Company snapshot</h3>
            <ul className="cs-facts">
              <li><div className="k">Industry</div><div className="v">HR &amp; global payroll</div></li>
              <li><div className="k">Company size</div><div className="v">201–500 employees</div></li>
              <li><div className="k">Location</div><div className="v">Global</div></li>
              <li><div className="k">Use case</div><div className="v">Cross-border hiring</div></li>
            </ul>
            ...
            <div className="cs-prod">
              ...
              <span className="cs-prodchip">Multilingual tests</span>
            </div>
