...
const stats = ['45+ coding languages', 'Live coding environments', '3,500+ validated tests'];
const logos = ['LTIMindtree', 'Sonatafy', 'Thales', 'Third Bridge', 'Cogitotech'];

const section1Bullets = [
  'Live coding in 45+ languages',
  'Debugging & code-review tasks',
  'System & API design',
  'Frontend, backend, data & DevOps',
  'Take-home and timed formats',
  'Auto-scored for accuracy & efficiency',
];
const section2Bullets = ['Screen before you interview', 'Auto-ranked shortlists', 'Consistent, fair evaluation'];
...
const ctaTicks = ['7-day free trial', '45+ coding languages', 'Cancel anytime'];
    ...
    <>
      ...
      <section className="tsd-hero" data-screen-label="Hero"><div className="tsdw tsd-hgrid">
        <div className="tsd-copy reveal">
          ...
          <h1 className="tsd-h1">Technical hiring, backed by real coding proof</h1>
          <p className="tsd-lead">Stop guessing from resumes. Assess engineers in real coding environments across 45+ languages, and only interview the ones who can actually build.</p>
      ...
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            ...
            <h2 className="tsd-h2">See how engineers actually work</h2>
            <p className="tsd-p">Interactive IDEs and real-world challenges test coding, debugging and system design the way the job demands — not trivia. You see the work, not just the claim.</p>
            <div className="tsd-bl">
              {section1Bullets.map((b, i) => (
                <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
              ))}
            </div>
            <Link className="tsd-link" href="/coding-tests">Explore coding tests<Arrow /></Link>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-slot"></div></div></div>
        </div>
      </div></section>
      ...
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-shead reveal"><p className="eyebrow">Why Testlify<b>.</b></p><h2 className="tsd-h2">Everything technical hiring needs</h2><p className="tsd-lead">Assess deeply, rank objectively, protect your engineers&apos; time.</p></div>
      ...
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            ...
            <h2 className="tsd-h2">Protect your engineers&apos; time</h2>
            <p className="tsd-p">Only candidates who clear the skills bar reach a live interview, so senior engineers spend their hours on the strongest applicants.</p>
            <div className="tsd-bl">
      ...
      <section className="tsd-cta" id="demo"><div className="tsdw reveal">
        ...
        <h2 className="tsd-h2">Hire engineers on proof, not resumes.</h2>
        <p className="tsd-lead">See who can actually build — start assessing technical talent in minutes.</p>
        <div className="tsd-ctas">
