...
const faqs = [
  { q: 'How does Testlify screen developers?', a: 'Testlify screens developers with role-based coding tests and real-world tasks that mirror the job. Every candidate takes the same test, scored on a fixed rubric, so your shortlist is objective and defensible. You can test Python, Java, JavaScript, TypeScript, Go, Ruby, PHP, C#, C++, Kotlin, Swift, Scala, R, and SQL and many more.' },
  { q: 'Which programming languages and frameworks can I test?', a: 'Testlify covers 20+ languages and frameworks, including Python, Java, JavaScript, TypeScript, Go, Ruby, PHP, C#, C++, Kotlin, Swift, Scala, R, and SQL, and frameworks such as React, Angular, Vue, Node.js, Django, Flask, Spring, Laravel, Rails, .NET, Flutter, GraphQL, plus cloud and DevOps skills like AWS, Azure, GCP, Docker, and Terraform. You can combine multiple tests into one assessment and add custom questions or tasks for niche and senior roles.' },
  { q: 'How do you stop cheating on coding tests?', a: 'Every coding test is proctored: candidate snapshots detect impersonation, tab-switch and mouse tracking flag suspicious activity, and plagiarism detection catches copied code. Questions are non-googleable and role-realistic, so scores reflect real ability.' },
  { q: 'Does Testlify integrate with our ATS?', a: 'Yes. Testlify connects to your ATS and hiring workflow with 100+ integrations, including BambooHR, Ashby, Breezy HR, Comeet, Cornerstone, and more, so technical screening slots into the process your team already runs.' },
...
const cards = [
  {
    title: 'Role-based coding tests',
    iconD: 'M16 18l6-6-6-6M8 6l-6 6 6 6',
    desc: 'Test Python, Java, JavaScript, TypeScript, Go, Ruby, PHP, C#, C++, Kotlin, Swift, Scala, R, and SQL, plus frameworks like React, Angular, Vue, Node.js, Django, Flask, Spring, Laravel, Rails, .NET, Flutter, GraphQL, plus cloud and DevOps skills like AWS, Azure, GCP, Docker, and Terraform. Every test is validated and mapped to real job tasks.',
  },
  {
    title: 'Real-world coding tasks',
    iconD: 'M9 11l3 3L22 4M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11',
    desc: 'Set real-world coding tasks and multiple difficulty levels, from junior to senior, so you screen for the exact seniority the role requires.',
  },
  {
    title: 'Powerful proctoring features',
    iconD: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z',
    desc: 'Advanced proctoring keeps results trustworthy: candidate snapshots to detect impersonation, tab-switch monitoring, mouse tracking, and plagiarism detection on code submissions.',
  },
];
    ...
    <>
      ...
      <section className="tsd-hero" data-screen-label="Hero"><div className="tsdw tsd-hgrid">
        <div className="tsd-copy reveal">
          <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Use case / Technical hiring</span></div>
          <p className="eyebrow">For technical hiring<b>.</b></p>
          <h1 className="tsd-h1">Screen developers on real skills with Testlify&apos;s technical hiring software</h1>
          <p className="tsd-lead">Screen, assess, and shortlist developers faster with role-based coding tests and real-world tasks, not resume guesswork. Evaluate engineers on the exact languages and frameworks your role uses, and hire on proven ability.</p>
          <div className="tsd-stats">
            <span className="tsd-statc">45+ coding languages</span>
            <span className="tsd-statc">Proctored assessments</span>
      ...
      {/* Section 1 — split, sand, shotBg #F3F6F9 */}
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Hire engineers who can build, not just interview well</h2>
            <p className="tsd-p">Evaluate experienced candidates&apos; skills to ensure they align perfectly with your job requirements with our technical hiring software.</p>
            <p className="tsd-p">Our tailored assessments gauge how well developers perform on real, job-realistic tasks through behavioral, psychometric, and cognitive tests, helping you minimize turnover.</p>
      ...
      {/* Section 2 — split flip, white, shotBg #FFF */}
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Technical hiring backed by real code, not resumes</h2>
            <p className="tsd-p">Hire for any technical role, from front end and back end to data, mobile, cloud, and DevOps, even for stacks your team does not know. Role-specific tests do the evaluation for you.</p>
            <div className="tsd-bl">
      ...
      {/* Section 3 — split, sand, shotBg #F3F6F9 */}
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Test the exact stack your role needs</h2>
            <p className="tsd-p">With Testlify&apos;s technical hiring software, screening developers at scale is effortless.</p>
            <div className="tsd-bl">
              <div className="tsd-bi"><Check /><span className="tsd-bt">Save time and onboard the right professionals by conducting simulation-based assessments at different levels.</span></div>
              <div className="tsd-bi"><Check /><span className="tsd-bt">AI-powered tests evaluation identifies the strengths and gaps of candidates effectively.</span></div>
              <div className="tsd-bi"><Check /><span className="tsd-bt">Eliminate unconscious bias with data-driven insights, ensuring a fair and objective hiring process.</span></div>
            </div>
            <Link className="tsd-link" href="/pricing">Try for free<Arrow /></Link>
          </div>
      ...
      {/* Section 4 — cards, white */}
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-shead reveal"><p className="eyebrow">Technical screening<b>.</b></p><h2 className="tsd-h2">A complete platform for technical screening</h2></div>
