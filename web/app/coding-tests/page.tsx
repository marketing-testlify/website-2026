          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">IP</span><div className="rt-ci"><span className="rt-nm">Ivan Petrov</span><span className="rt-role">Full-stack Developer · Coding</span></div><span className="rt-fit">Passed · 94%</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Correctness</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '94%', animationDelay: '.15s' }}></i></span><span className="ithero-scv">94</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Efficiency</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '90%', animationDelay: '.3s' }}></i></span><span className="ithero-scv">90</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Code structure</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '86%', animationDelay: '.45s' }}></i></span><span className="ithero-scv">86</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Edge cases</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' }}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-shead reveal">
            ...
            <h2 className="tsd-h2">What does Testlify have to offer?</h2>
