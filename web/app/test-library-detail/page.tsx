      ...
      <section className="sec" style={{ background: '#FBF3EE' }}><div className="wrap">
        <div className="smegrid">
          <div>
            ...
            <Link className="smelink reveal" style={{ transitionDelay: '.12s' }} href="/trust">See the science behind our tests<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 6l6 6-6 6"></path></svg></Link>
          </div>
