...
const FAQ_ITEMS = [
  {
    q: 'How to calculate interview to offer ratio?',
    a: 'Divide the total number of interviews conducted by the number of offers made. Example: 20 interviews / 5 offers = 4:1 ratio.',
  },
  {
    q: 'How to calculate offer to joining ratio?',
    a: 'Divide the number of candidates who joined by the total offers made, then multiply by 100 for a percentage.',
  },
  {
    q: 'What does an 80/20 ratio mean in interviewing?',
    a: 'It means 80% of your hiring success comes from 20% of your efforts or candidates, often highlighting the most impactful sourcing or interview methods.',
  },
  {
    q: 'What is a good interview ratio?',
    a: 'A good interview-to-offer ratio varies by industry, but 3:1 to 5:1 is often considered efficient.',
  },
];
...
export default function InterviewToOfferRatioCalculatorPage() {
  ...
  const { result, rate, note } = useMemo(() => {
    const intvNum = num(intv);
    const offNum = Math.max(1, num(off));
    const ratio = intvNum / offNum;
    return {
      result: ratio.toFixed(1) + ':1',
      rate: intvNum ? Math.round((offNum / intvNum) * 100) + '%' : '—',
      note:
        ratio <= 4
    ...
    <>
        ...
        <div className="tw">
          ...
          <div style={{ maxWidth: 720 }}>
            <p className="eyebrow reveal">
              Interview to offer ratio<b>.</b>
            </p>
            <h1 className="th1 reveal" style={{ transitionDelay: '.04s' }}>
              Calculate your interview-to-offer ratio
            </h1>
            <p className="tlead reveal" style={{ transitionDelay: '.08s' }}>
              How many interviews does it take to make an offer? Enter your numbers to
              see the ratio — a high one usually means candidates arrive at interviews
              under-qualified.
            </p>
          </div>
        </div>
      ...
      <section className="tsec">
        <div className="tw">
          <div style={{ maxWidth: 640 }}>
            ...
            <p className="tlead reveal" style={{ transitionDelay: '.08s' }}>
              The interview-to-offer ratio divides interviews by offers. A lower ratio
              means your pipeline is well-qualified before interviews begin. Skills
              screening earlier is the simplest way to bring it down.
            </p>
          </div>
          <div className="tsteps">
            <div className="tstep reveal">
              ...
              <p className="tbody" style={{ margin: 0, fontSize: 14.5 }}>
                Total interviews conducted over the period.
              </p>
            </div>
            <div className="tstep reveal" style={{ transitionDelay: '.06s' }}>
              ...
              <p className="tbody" style={{ margin: 0, fontSize: 14.5 }}>
                The number of offers you extended.
              </p>
            </div>
            <div className="tstep reveal" style={{ transitionDelay: '.12s' }}>
              ...
              <p className="tbody" style={{ margin: 0, fontSize: 14.5 }}>
                Fewer interviews per offer means a stronger pipeline.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="tsec" style={{ background: '#FBF3EE' }}>
        <div className="tw">
          <div style={{ maxWidth: 640 }}>
            <p className="eyebrow reveal">
              Reading the ratio<b>.</b>
            </p>
            <h2 className="th2 reveal" style={{ transitionDelay: '.04s' }}>
              What the ratio tells you
            </h2>
          </div>
          <div className="trelgrid reveal" style={{ gridTemplateColumns: 'repeat(3,1fr)' }}>
            <div className="trelcard">
              <p className="trelt">&lt; 8%</p>
              <p className="treld">High volume, low yield — screening or job specs may be off.</p>
            </div>
            <div className="trelcard">
              <p className="trelt">8–15%</p>
              <p className="treld">Industry average — a healthy pipeline.</p>
            </div>
            <div className="trelcard">
              <p className="trelt">&gt; 15%</p>
              <p className="treld">Lean, targeted process — candidates are pre-qualified.</p>
            </div>
          </div>
        </div>
      </section>
