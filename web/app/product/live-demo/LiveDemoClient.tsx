          ...
          <div className="relative grid grid-cols-1 min-[961px]:grid-cols-[1.02fr_1.08fr] gap-11 min-[961px]:gap-[60px] items-center">
            <div>
              ...
              >
                See Testlify live,
                <br />
                end to <span className="text-coral">end.</span>
              </Reveal>
              <Reveal as="p" delay={0.1} className={`${LEAD} text-body mt-[22px] mb-0 max-w-[520px]`}>
                Watch how Testlify screens, interviews and scores candidates automatically — a guided walkthrough of
                the full skills-based hiring workflow, from first application to verified shortlist.
              </Reveal>
