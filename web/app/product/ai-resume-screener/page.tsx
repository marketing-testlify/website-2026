...
const FAQ_ITEMS = [
  {
    q: "What is Testlify's AI Resume Screener?",
    a: "It automatically analyses résumés pulled from your ATS and scores each candidate on how well they fit the job — so you can quickly find and shortlist the best talent without reading every application by hand.",
  },
  {
    q: "How does the AI determine candidate fit?",
    a: "The AI evaluates each candidate against the role-specific criteria you set, then returns clear match scores and fit labels — High, Medium or Low — with the evidence behind every call.",
  },
  {
    q: "Can I automate candidate shortlisting and assessments?",
    a: "Yes. Set thresholds to automatically shortlist or reject candidates, and trigger skill assessments for everyone who meets your bar.",
  },
  {
    q: "Does your résumé screening tool integrate with my ATS?",
    a: "Absolutely. Testlify pulls résumés from your ATS and pushes back both match scores and assessment results for a seamless, two-way workflow — natively, across 100+ ATS platforms.",
  },
  {
    q: "Can I customise screening criteria for different roles?",
    a: "Yes. Define role-specific requirements, set cut-off scores and adjust thresholds to match the exact needs of every role you hire for.",
  },
  {
    q: "How does Testlify ensure fairness and reduce bias?",
    a: "The AI applies consistent, role-based criteria across all résumés, standardising evaluation and reducing human bias in shortlisting — with a defensible audit trail for every decision.",
  },
  {
    q: "How secure is candidate data?",
    a: "Testlify meets enterprise-grade standards: SOC 2 Type II and ISO 27001, with GDPR, CCPA and NY Bias Law compliance, and encryption in transit and at rest. Your data is never used to train shared models.",
  },
  {
    q: "How many candidates can Testlify screen?",
    a: "Testlify scales effortlessly, screening thousands of résumés every month without slowing your recruitment process down.",
  },
  {
    q: "Can I see the scores and fit labels before making a decision?",
    a: "Yes. Every match score and fit label is transparent and explainable, giving you complete visibility before you advance any candidate.",
  },
  {
    q: "How quickly can we start using the AI Resume Screener?",
    a: "You can get started in days, not weeks. Our team helps set up integrations, thresholds and workflows to get your screening running fast.",
  },
];
...
export default function Page() {
  return (
    <>
      ...
      <style>{`.ars-demo > span:first-child{width:24px;height:24px;}`}</style>
        ...
        <div className={WRAP}>
          <div className="grid grid-cols-[1.02fr_1.1fr] gap-[60px] items-center max-[960px]:grid-cols-1 max-[960px]:gap-11">
            <div>
              ...
              >
                Intelligent r&eacute;sum&eacute;
                <br />
