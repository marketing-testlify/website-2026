...
export default function SoftwareSkillsTestsPage() {
        ...
        <div className="tsdw tsd-hgrid">
          <div className="tsd-copy reveal">
            ...
            <div className="tsd-stats">
              ...
              <span className="tsd-statc">Instant top-performer flags</span>
            </div>
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">NV</span><div className="rt-ci"><span className="rt-nm">Nora Vance</span><span className="rt-role">Operations Associate · Software fluent</span></div><span className="rt-fit">Job-ready</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Excel / Sheets</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '93%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">93</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Comms tools</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '89%', animationDelay: '.3s' } as React.CSSProperties}></i></span><span className="ithero-scv">89</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">CRM</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' } as React.CSSProperties}></i></span><span className="ithero-scv">85</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Docs &amp; slides</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' } as React.CSSProperties}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
