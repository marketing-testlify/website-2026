    ...
    <>
      ...
      <section className="tsd-hero">
        <div className="tsdw tsd-hgrid">
          <div className="tsd-copy reveal">
            <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Industry / Media</span></div>
            <p className="eyebrow">For media teams<b>.</b></p>
            <h1 className="tsd-h1">Skills assessments for the <span style={{ color: '#F23F44' }}>Media industry</span></h1>
            <p className="tsd-lead">Recruiters in the media industry face the challenge of hiring top-tier creative talent, ensuring alignment with evolving digital trends and evaluating diverse skill sets. Testlify&apos;s skills assessments for media use engaging, perceptive tests to validate candidates&apos; skills — removing uncertainty from the hiring process.</p>
            <div className="tsd-stats">
              <span className="tsd-statc">3,500+ validated tests</span>
              <span className="tsd-statc">Creative &amp; soft-skill tests</span>
              <span className="tsd-statc">Role-specific assessments</span>
            </div>
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">LC</span><div className="rt-ci"><span className="rt-nm">Leah Cohen</span><span className="rt-role">Content Producer · Media</span></div><span className="rt-fit">Team fit</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Creativity</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '93%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">93</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Communication</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '90%', animationDelay: '.3s' } as React.CSSProperties}></i></span><span className="ithero-scv">90</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Collaboration</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' } as React.CSSProperties}></i></span><span className="ithero-scv">85</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Adaptability</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' } as React.CSSProperties}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
      ...
      <section className="tsd-sec">
        <div className="tsdw">
          <div className="tsd-grid2">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Upgrade your talent search for media industry professionals</h2>
              <p className="tsd-p">Find qualified, skilled candidates by assessing them across all aspects — and hire the best for your organization.</p>
              <div className="tsd-bl tsd-bl1">
                {['Identify top-tier media professionals', 'Use excellent features for accurate insights', 'Customize assessments to match your industry requirements', 'Experience a seamless media hiring workflow'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
              <Link className="tsd-link" href="/features">Explore features<Arrow /></Link>
            </div>
            <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/Upgrade-your-talent-search-for-media-industry-professionals.png")' }}></div></div></div>
          </div>
        </div>
      </section>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-grid2 tsd-flip">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Curated role-specific assessments for the media industry</h2>
              <p className="tsd-p">Skills assessment is the key to identifying the perfect fit for your team&apos;s unique roles. Discover unparalleled efficiency and accuracy as you customize assessments.</p>
              <div className="tsd-bl tsd-bl1">
                {['Assess writers, editors and content creators', 'Evaluate social media strategists and managers', 'Gauge the skills of audio and video professionals', 'Customize assessments for your unique media positions'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
              <Link className="tsd-link" href="/test-library">Check out our test library<Arrow /></Link>
            </div>
            <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/Curated-role-specific-assessments-for-the-media-industry.png")' }}></div></div></div>
          </div>
        </div>
      </section>
      ...
      <section className="tsd-sec">
        <div className="tsdw">
          <div className="tsd-grid2">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Soft skills to assess for Media industry roles</h2>
              <p className="tsd-p">Build an amazing media team by assessing essential soft skills — measuring every skill required for any role you&apos;re hiring for with precision.</p>
              <div className="tsd-bl tsd-bl1">
                {['Communication skills', 'Language proficiency skills', 'Creativity skills', 'Collaboration skills', 'Time management skills'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
            </div>
            <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/Soft-skills-to-assess-for-Media-industry-role.png")' }}></div></div></div>
          </div>
        </div>
      </section>

      {/* Section 4 — split (sand, flip) */}
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-grid2 tsd-flip">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">What do we have for you to hire media industry professionals?</h2>
              <p className="tsd-p">We&apos;ve proven to be a catalyst for enhancing efficiency in the quest for top-tier media talent. Explore our comprehensive assessments, tailor-made for diverse media roles, and leverage customizable tests aligned with your unique hiring goals.</p>
              <div className="tsd-bl tsd-bl1">
                {['Cutting-edge technology for precise evaluations', 'Comprehensive assessments for diverse media roles', 'Customizable tests to align with your hiring goals', 'Proven success in enhancing recruitment efficiency'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
              <Link className="tsd-link" href="/contact">Book a demo<Arrow /></Link>
            </div>
            <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/What-do-we-have-for-you-to-hire-media-industry-professionals.png")' }}></div></div></div>
          </div>
        </div>
      </section>
      ...
      <Testimonials eyebrow="Testimonials" heading="What media and creative teams say about skills-based hiring" />
