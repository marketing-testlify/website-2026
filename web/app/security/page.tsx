...
export default function SecurityPage() {
  return (
    <>
      <SiteHeader
        announcement="SOC 2 Type II · ISO 27001 · GDPR · CCPA"
      ...
      <section className="phero">
        <div className="wrap" style={{ maxWidth: '860px' }}>
          ...
          <p className="lead reveal" style={{ margin: '22px auto 0', maxWidth: '640px', transitionDelay: '.08s' }}>
            Your data and your candidates&apos; data deserve the highest protection. Testlify is built on independently audited controls — encryption, access management and continuous monitoring — on every plan.
          </p>
          <div className="reveal btnrow" style={{ marginTop: '30px', transitionDelay: '.12s' }}>
            <CtaButton label="Visit trust center" href="https://trust.testlify.com/" variant="primary" size="md" icon="arrow" />
        ...
        <div className="wrap">
          ...
          <div className="grid3">
            <div className="card reveal">
              ...
              <h3 className="h3" style={{ fontSize: '18px', marginBottom: '8px' }}>Encryption everywhere</h3>
              <p className="body" style={{ fontSize: '14px' }}>Data is encrypted in transit (TLS 1.2+) and at rest (AES-256) across the platform.</p>
            </div>
            <div className="card reveal" style={{ transitionDelay: '.06s' }}>
              ...
              <h3 className="h3" style={{ fontSize: '18px', marginBottom: '8px' }}>Access controls</h3>
              <p className="body" style={{ fontSize: '14px' }}>Role-based permissions, SSO and least-privilege access keep data in the right hands.</p>
            </div>
            <div className="card reveal" style={{ transitionDelay: '.12s' }}>
              ...
              <h3 className="h3" style={{ fontSize: '18px', marginBottom: '8px' }}>Continuous monitoring</h3>
              <p className="body" style={{ fontSize: '14px' }}>24/7 monitoring, logging and alerting detect and respond to threats fast.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <SecuritySection
        ...
        sub="Enterprise-grade security and privacy controls, independently audited and available on every plan."
      />
      ...
      <section className="sec darkcta">
        <div className="wrap" style={{ maxWidth: '720px' }}>
          ...
          <p className="lead reveal" style={{ margin: '18px auto 30px', transitionDelay: '.04s' }}>
            Explore our practices, standards and architecture — or request our reports.
          </p>
          <div className="reveal btnrow" style={{ transitionDelay: '.08s' }}>
            ...
            <CtaButton label="Trust center" href="https://trust.testlify.com/" variant="outline-light" size="md" icon="none" />
          </div>
        </div>
      </section>
