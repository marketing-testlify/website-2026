...
const bullets1 = [
  ...
  '45+ programming-language coding environments',
  'Custom workflows for high-volume hiring',
  'Global benchmarking to compare top talent',
  'Built-in 100+ ATS, Slack and API integrations',
  'Advanced anti-cheating and proctoring',
];
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">LV</span><div className="rt-ci"><span className="rt-nm">Lena Vogel</span><span className="rt-role">Engineering Manager · Enterprise</span></div><span className="rt-fit">Global hire</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Versatility</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '90%', animationDelay: '.15s' }}></i></span><span className="ithero-scv">90</span></div>
                  ...
                  <div className="ithero-scr"><span className="ithero-scl">Reliability</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' }}></i></span><span className="ithero-scv">85</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Tech literacy</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' }}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-shead reveal">
            <p className="eyebrow">Outcomes<b>.</b></p>
