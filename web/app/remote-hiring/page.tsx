    ...
    <>
      ...
      <section className="tsd-hero">
        <div className="tsdw tsd-hgrid">
          <div className="tsd-copy reveal">
            <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Use case / Remote hiring</span></div>
            <p className="eyebrow">For remote hiring<b>.</b></p>
            <h1 className="tsd-h1">Hire top talent with our <span className="tac">remote hiring software</span></h1>
            <p className="tsd-lead">Find, assess and onboard top talent from anywhere in the world with our remote hiring software. Developed by experts, it helps you discover the best talent for any job, anywhere.</p>
            <div className="tsd-stats">
              <span className="tsd-statc">1,700+ tests</span>
              <span className="tsd-statc">9+ languages</span>
          ...
          <div className="tsd-media">
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand"><span className="rt-av">DF</span><div className="rt-ci"><span className="rt-nm">Diego Fernandez</span><span className="rt-role">Remote Engineer · Global</span></div><span className="rt-fit">Remote-ready</span></div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Technical skills</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '93%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">93</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Communication</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '89%', animationDelay: '.3s' } as React.CSSProperties}></i></span><span className="ithero-scv">89</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Autonomy</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '85%', animationDelay: '.45s' } as React.CSSProperties}></i></span><span className="ithero-scv">85</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Collaboration</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' } as React.CSSProperties}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
      ...
      <section className="tsd-sec">
        <div className="tsdw">
          <div className="tsd-grid2">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Your hunt for top talent ends with Testlify</h2>
              <p className="tsd-p">Finding the best talent is difficult but possible. Enhance your recruitment strategy and secure high-quality talent with our remote hiring software — an intelligent tool that provides a seamless hiring experience, real-time candidate insights and efficient evaluation.</p>
              <div className="tsd-bl">
                {['Assess global talent with ease and precision', 'Better collaboration with real-time feedback and grading', 'Data-driven hiring decisions with advanced analytics and reporting'].map((b, i) => (
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-grid2 tsd-flip">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Leverage world-class talent faster and smarter</h2>
              <p className="tsd-p">With Testlify&apos;s intuitive platform, companies can hire top talent more efficiently — improving both candidate and recruiter experience, enhancing accuracy and reducing time-to-hire.</p>
              <div className="tsd-bl">
                {['1,700+ tests for 5,000+ job roles and 50+ industries', 'Advanced proctoring features to ensure assessment integrity', 'Comprehensive reporting to analyze performance at a glance', 'Video and audio interview features for a 360° evaluation', 'Multilingual assessments available in 9+ languages', 'Efficient candidate screening with skills assessments'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
      ...
      <section className="tsd-sec">
        <div className="tsdw">
          <div className="tsd-grid2">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Break through barriers with Testlify</h2>
              <p className="tsd-p">Testlify&apos;s remote hiring software lets you conduct accurate assessments tailored to each job and assess talent across the globe. It also evaluates candidates&apos; cultural fit, ensuring you hire talent that aligns with your organization&apos;s values and environment.</p>
              <div className="tsd-bl">
                {['Say bye to technical challenges', 'Positive candidate experience', 'Reduce chances of mis-hires'].map((b, i) => (
                  <div className="tsd-bi" key={i}><Check /><span className="tsd-bt">{b}</span></div>
                ))}
              </div>
            </div>
      ...
      <section className="tsd-sec tsd-sand">
        <div className="tsdw">
          <div className="tsd-grid2 tsd-flip">
            <div className="tsd-copy reveal">
              <h2 className="tsd-h2">Explore our extensive library of skills tests</h2>
