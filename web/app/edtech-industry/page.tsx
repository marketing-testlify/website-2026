...
.tsd-shot{background:#F3F6F9;border:1px solid #DDE7F0;border-radius:22px;padding:0;box-shadow:0 40px 90px rgba(110,11,14,.14);overflow:hidden;}
.tsd-shot image-slot{display:block;width:100%;height:360px;border-radius:14px;overflow:hidden;}
.tsd-shotimg{display:block;width:100%;height:360px;background-size:contain;background-repeat:no-repeat;background-position:center;background-color:#F3F6F9;border-radius:14px;}
.tsd-flip .tsd-shot{background:#fff!important;border-color:#F0E2E3!important;}
.tsd-flip .tsd-shotimg{background-color:#fff!important;}
.tsd-shot.shot-blue{background:#F3F6F9!important;border-color:#DDE7F0!important;}
.tsd-shot.shot-blue .tsd-shotimg{background-color:#F3F6F9!important;}
    ...
    <>
      ...
      <section className="tsd-hero" data-screen-label="Hero"><div className="tsdw tsd-hgrid">
        <div className="tsd-copy reveal">
          <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Industry / Edtech</span></div>
          <p className="eyebrow">For edtech teams<b>.</b></p>
          <h1 className="tsd-h1">Maximizing your hiring success in the <span style={{ color: '#F23F44' }}>Edtech industry</span></h1>
          <p className="tsd-lead">As the Edtech industry continues to grow, it&rsquo;s more important than ever to find the right candidates for your team. Testlify helps you do exactly that with a comprehensive assessment of each candidate&rsquo;s skills — giving you accurate insights into their knowledge and abilities, so you focus only on candidates who meet your requirements.</p>
          <div className="tsd-stats">
            <span className="tsd-statc">3,500+ validated tests</span>
            <span className="tsd-statc">Role &amp; cognitive tests</span>
            <span className="tsd-statc">Data-driven results</span>
          </div>
        ...
        <div className="tsd-media"><div className="ithero-wrap">
          <div className="ithero-card">
            ...
            <div className="rt-cand"><span className="rt-av">AK</span><div className="rt-ci"><span className="rt-nm">Aria Khan</span><span className="rt-role">Curriculum Lead · Edtech</span></div><span className="rt-fit">Team fit</span></div>
            <div className="ithero-scores">
              <div className="ithero-scr"><span className="ithero-scl">Subject expertise</span><span className="ithero-scbar"><i style={{ '--w': '93%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">93</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Communication</span><span className="ithero-scbar"><i style={{ '--w': '89%', animationDelay: '.3s' } as React.CSSProperties}></i></span><span className="ithero-scv">89</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Collaboration</span><span className="ithero-scbar"><i style={{ '--w': '85%', animationDelay: '.45s' } as React.CSSProperties}></i></span><span className="ithero-scv">85</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Adaptability</span><span className="ithero-scbar"><i style={{ '--w': '82%', animationDelay: '.6s' } as React.CSSProperties}></i></span><span className="ithero-scv">82</span></div>
            </div>
          </div>
      ...
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Assessing key competencies</h2>
            <p className="tsd-p">To ensure that your Edtech team is staffed with the most qualified candidates, it&rsquo;s important to evaluate their competencies.</p>
            <p className="tsd-p">Our pre-designed assessments are specifically tailored to measure the essential competencies for the Edtech industry.</p>
            <p className="tsd-p">By using our assessments, you can be sure that you are hiring candidates who possess the necessary skills and knowledge to succeed in the fast-paced world of EdTech.</p>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/Assessing-key-competencies-1-1024x1024.png")' }}></div></div></div>
        </div>
      </div></section>
      ...
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Enhancing the quality of hire</h2>
            <p className="tsd-p">Selecting the right candidates for your Edtech team is critical to its success. Testlify provides a reliable solution to help you identify the best talent for your team.</p>
            <p className="tsd-p">Our assessments are meticulously designed to evaluate the competencies and skills required to excel in the EdTech industry. This helps you to improve the quality of your hiring decisions, leading to a more productive and successful team overall.</p>
            <p className="tsd-p">Hiring the right talent enables you to deliver a better user experience, generate innovative solutions for the market, and have a positive impact on education.</p>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/Enhancing-the-quality-of-hire-1-1024x1024.png")' }}></div></div></div>
        </div>
      </div></section>
      ...
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Optimizing the recruitment process with ATS integration</h2>
            <p className="tsd-p">Improve your candidate management process with Testlify&rsquo;s ATS integration. By seamlessly integrating our talent assessments with your existing ATS system, you can simplify your hiring process and concentrate on the most critical task: finding the right talent for your team.</p>
            <p className="tsd-p">With Testlify&rsquo;s ATS integration, managing candidates becomes effortless, enabling you to streamline your workflow and improve overall recruitment efficiency.</p>
            <Link className="tsd-link" href="/test-library">View our test library{ARROW}</Link>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/Optimizing-the-recruitment-process-with-ATS-integration.png")' }}></div></div></div>
        </div>
      </div></section>

      {/* Section 4 — bullets, sand */}
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <p className="eyebrow">Test coverage<b>.</b></p>
            <h2 className="tsd-h2">Gain valuable insight into candidates&rsquo; skills</h2>
            <p className="tsd-p">Our assessments are designed to provide you with accurate insights into candidates&rsquo; skills and aptitudes. With our platform, you can test candidates&rsquo; knowledge, cognitive abilities, and behavioral traits to make informed hiring decisions.</p>
            <Link className="tsd-link" href="/test-library">View our test library{ARROW}</Link>
          </div>
          <div className="tsd-copy reveal">
            <div className="tsd-bl tsd-bl1">
              {['Communication Skills', 'Customer support', 'Time Management', 'Teamwork'].map((b, i) => (
      ...
      {/* Section 5 — split, flip, white, shot-blue */}
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Why choose Testlify for hiring in the Edtech industry?</h2>
            <p className="tsd-p">Testlify offers a specialized hiring process designed for the Edtech industry, enabling recruiters to evaluate candidates&rsquo; skills with precision.</p>
            <p className="tsd-p">Our data-driven results provide an objective evaluation of candidates, increasing the efficiency of the recruitment process.</p>
            <div className="tsd-bl tsd-bl1">
              {['Assess a Candidate’s Skills', 'Curate your own Assessments', 'Objective and Data-Driven Results', 'Increased Efficiency'].map((b, i) => (
                <div className="tsd-bi" key={i}>{CHECK}<span className="tsd-bt">{b}</span></div>
              ))}
            </div>
            <Link className="tsd-link" href="/pricing">Try for free{ARROW}</Link>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot shot-blue"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2024/11/Why-choose-Testlify-for-hiring-in-the-Edtech-industry-1-1024x1024.png")' }}></div></div></div>
        </div>
      </div></section>
      ...
      <Testimonials eyebrow="Testimonials" heading="What EdTech hiring teams say about skills-based hiring" />
