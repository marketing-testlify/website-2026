...
export default function PublicSectorTalentAssessmentSolutionPage() {
    ...
    <>
      ...
      <section className="tsd-hero" data-screen-label="Hero"><div className="tsdw tsd-hgrid">
        <div className="tsd-copy reveal">
          <div className="tsd-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Company size / Public sector</span></div>
          <p className="eyebrow">For public sector<b>.</b></p>
          <h1 className="tsd-h1">Public sector talent assessment solution</h1>
          <p className="tsd-lead">Testlify empowers public sector organizations to make informed hiring decisions, build a mission-ready workforce and cultivate top talent — deploying the right people at the right time and fostering a diverse, equitable and inclusive workforce.</p>
          <div className="tsd-stats">
            <span className="tsd-statc">EEOC-defensible</span>
            <span className="tsd-statc">Secure &amp; confidential</span>
            <span className="tsd-statc">DEI-first assessments</span>
          </div>
        ...
        <div className="tsd-media"><div className="ithero-wrap">
          <div className="ithero-card">
            ...
            <div className="rt-cand"><span className="rt-av">DO</span><div className="rt-ci"><span className="rt-nm">David Osei</span><span className="rt-role">Policy Analyst · Public sector</span></div><span className="rt-fit">Mission-ready</span></div>
            <div className="ithero-scores">
              <div className="ithero-scr"><span className="ithero-scl">Domain knowledge</span><span className="ithero-scbar"><i style={{ '--w': '92%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="ithero-scv">92</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Critical thinking</span><span className="ithero-scbar"><i style={{ '--w': '89%', animationDelay: '.3s' } as React.CSSProperties}></i></span><span className="ithero-scv">89</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Integrity</span><span className="ithero-scbar"><i style={{ '--w': '86%', animationDelay: '.45s' } as React.CSSProperties}></i></span><span className="ithero-scv">86</span></div>
              <div className="ithero-scr"><span className="ithero-scl">Communication</span><span className="ithero-scbar"><i style={{ '--w': '82%', animationDelay: '.6s' } as React.CSSProperties}></i></span><span className="ithero-scv">82</span></div>
            </div>
          </div>
      ...
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Streamline recruitment and deployment processes</h2>
            <p className="tsd-p">Finding the right talent for crucial public sector roles is essential for success. Our comprehensive assessment solution helps you streamline recruitment and deployment.</p>
            <p className="tsd-p">Advanced assessments identify candidates with the necessary skills, knowledge and competencies for specific positions — so you deploy the right talent at the right time and drive positive outcomes.</p>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2022/09/Hire-Fast-or-Lose-1024x786.png")' }}></div></div></div>
        </div>
      </div></section>
      ...
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Identify promising candidates</h2>
            <p className="tsd-p">Discovering new talent is key to the growth and success of any organization. With Testlify, you identify promising candidates with the skills and potential to excel in the public sector.</p>
            <p className="tsd-p">Our assessments evaluate aptitude, problem-solving, critical thinking and more — uncovering hidden talent and individuals who can make a significant impact.</p>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2023/06/Product-image-1-4-1024x741.png")' }}></div></div></div>
        </div>
      </div></section>
      ...
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-grid2">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Nurture and develop your workforce</h2>
            <p className="tsd-p">Building a strong workforce requires cultivating and developing top talent. Testlify provides the tools and insights to nurture the potential of your employees.</p>
            <p className="tsd-p">With personalized development plans, tailored feedback and performance tracking, you enhance productivity, boost engagement and foster a culture of continuous improvement.</p>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2022/09/2.-Hyper-Growth-Industry-1024x1024.png")' }}></div></div></div>
        </div>
      </div></section>

      {/* Section 4 — split, flip, sand */}
      <section className="tsd-sec tsd-sand"><div className="tsdw">
        <div className="tsd-grid2 tsd-flip">
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">Assess skills and competencies</h2>
            <p className="tsd-p">Preparing your workforce for the challenges of the public sector requires a clear understanding of their skills. Testlify helps you assess capabilities, identify skills gaps and develop targeted training programs — building a mission-ready workforce equipped to drive positive change.</p>
            <Link className="tsd-link" href="/test-library">View our test library{ARROW}</Link>
          </div>
          <div className="tsd-media reveal"><div className="tsd-shot"><div className="tsd-shotimg" style={{ backgroundImage: 'url("https://testlify.com/wp-content/uploads/2023/07/Before-you-continue-01-2-1024x761.png")' }}></div></div></div>
        </div>
      </div></section>

      {/* Section 5 — cards, white */}
      <section className="tsd-sec"><div className="tsdw">
        <div className="tsd-shead reveal"><p className="eyebrow">Built for public sector<b>.</b></p><h2 className="tsd-h2">Trusted, secure and inclusive by design</h2><p className="tsd-lead">Everything public sector hiring demands, in one platform.</p></div>
