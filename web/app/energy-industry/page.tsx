...
export default function EnergyIndustryPage() {
  ...
  return (
    <>
            ...
            <div className="fin-hero-card">
              ...
              <div className="fin-score">
                ...
                <div className="rt-scores">
                  <div className="rt-scr"><span className="rt-scl">HSE / OSHA knowledge</span><span className="rt-scbar"><i style={{ '--w': '94%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="rt-scv">94</span></div>
                  <div className="rt-scr"><span className="rt-scl">Technical aptitude</span><span className="rt-scbar"><i style={{ '--w': '88%', animationDelay: '.28s' } as React.CSSProperties}></i></span><span className="rt-scv">88</span></div>
                  <div className="rt-scr"><span className="rt-scl">SCADA knowledge</span><span className="rt-scbar"><i style={{ '--w': '84%', animationDelay: '.41s' } as React.CSSProperties}></i></span><span className="rt-scv">84</span></div>
                  <div className="rt-scr"><span className="rt-scl">Situational judgment</span><span className="rt-scbar"><i style={{ '--w': '91%', animationDelay: '.54s' } as React.CSSProperties}></i></span><span className="rt-scv">91</span></div>
                  <div className="rt-scr"><span className="rt-scl">Cognitive aptitude</span><span className="rt-scbar"><i style={{ '--w': '86%', animationDelay: '.67s' } as React.CSSProperties}></i></span><span className="rt-scv">86</span></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="rtsec rtsand" style={{ paddingTop: '44px', paddingBottom: '44px' }} ref={statRef}>
        <div className="rtw">
          <div className="statrow statrow3 reveal">
            <div className="stat"><div className="statn"><span className="v" data-to="3500" data-comma="1">0</span><span className="u">+</span></div><div className="statl">Ready-made validated tests</div></div>
            <div className="stat"><div className="statn"><span className="v" data-to="4500" data-comma="1">0</span><span className="u">+</span></div><div className="statl">Job roles covered</div></div>
            <div className="stat"><div className="statn"><span className="v" data-to="100">0</span><span className="u">+</span></div><div className="statl">Native ATS integrations</div></div>
          </div>
        </div>
      </section>
          ...
          <div className="rt-g2" style={{ marginTop: '56px' }}>
            <div className="rt-copy reveal">
              ...
              <div className="rt-chk">
                <div className="rt-ci"><Check />OSHA, HSE, and environmental compliance modules validated for energy roles</div>
                <div className="rt-ci"><Check />Set minimum pass scores per module so only qualified candidates advance automatically</div>
                <div className="rt-ci"><Check />Situational judgment scenarios based on real field and site contexts</div>
              </div>
            </div>
            <div className="rt-media reveal">
              <div className="fin-card">
                ...
                <div className="fin-card-b">
                  ...
                  <div className="rt-scores" style={{ marginTop: '18px' }}>
                    <div className="rt-scr"><span className="rt-scl">OSHA / HSE knowledge</span><span className="rt-scbar"><i style={{ '--w': '94%', animationDelay: '.15s' } as React.CSSProperties}></i></span><span className="rt-scv">94</span></div>
                    <div className="rt-scr"><span className="rt-scl">Environmental compliance</span><span className="rt-scbar"><i style={{ '--w': '88%', animationDelay: '.28s' } as React.CSSProperties}></i></span><span className="rt-scv">88</span></div>
                    <div className="rt-scr"><span className="rt-scl">Situational judgment</span><span className="rt-scbar"><i style={{ '--w': '91%', animationDelay: '.41s' } as React.CSSProperties}></i></span><span className="rt-scv">91</span></div>
                    <div className="rt-scr"><span className="rt-scl">Incident reporting</span><span className="rt-scbar"><i style={{ '--w': '86%', animationDelay: '.54s' } as React.CSSProperties}></i></span><span className="rt-scv">86</span></div>
                    <div className="rt-scr"><span className="rt-scl">Risk identification</span><span className="rt-scbar"><i style={{ '--w': '93%', animationDelay: '.67s' } as React.CSSProperties}></i></span><span className="rt-scv">93</span></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="rtsec rtsand">
        <div className="rtw rt-g2 rt-flip">
          <div className="rt-copy reveal">
            ...
            <div className="rt-chk">
              <div className="rt-ci"><Check />Mechanical aptitude: equipment operation, troubleshooting, and technical drawings</div>
              <div className="rt-ci"><Check />Electrical aptitude: wiring, systems knowledge, and safety standards</div>
              <div className="rt-ci"><Check />Cognitive aptitude for engineering and supervisor-level roles</div>
            </div>
          </div>
          <div className="rt-media reveal">
            <div className="fin-card">
      ...
      <section className="rtsec">
        <div className="rtw rt-g2">
          <div className="rt-copy reveal">
            ...
            <div className="rt-chk">
              <div className="rt-ci"><Check />SCADA systems, control room procedures, and grid monitoring knowledge</div>
              <div className="rt-ci"><Check />Attention-to-detail and cognitive aptitude benchmarks for high-stakes operations roles</div>
              <div className="rt-ci"><Check />Role-specific test modules for utilities, substations, and energy storage</div>
            </div>
          </div>
          <div className="rt-media reveal">
            <div className="fin-card">
      ...
      <section className="rtsec rtsand">
        <div className="rtw rt-g2 rt-flip">
          <div className="rt-copy reveal">
            ...
            <div className="rt-chk">
              <div className="rt-ci"><Check />Webcam monitoring, tab-switch detection, and IP verification built in</div>
              <div className="rt-ci"><Check />Timestamped candidate logs exportable on demand for internal and regulatory review</div>
              <div className="rt-ci"><Check />SOC 2 Type 2 and ISO 27001 certified, GDPR and CCPA compliant</div>
            </div>
          </div>
          <div className="rt-media reveal">
            <div className="fin-card">
      ...
      <section className="rtsec">
        <div className="rtw">
          <div className="rt-shead reveal" style={{ textAlign: 'left', maxWidth: 'none' }}><h2 className="rt-h2" style={{ fontSize: '44px' }}>What energy and utility hiring teams say</h2></div>
      ...
      <section className="rtsec">
        <div className="rtw">
          <div className="rt-shead reveal"><p className="eyebrow">FAQ<b>.</b></p><h2 className="rt-h2">Frequently asked questions (FAQs)</h2><p className="rt-lead">Here are answers to the most commonly asked questions about Testlify&apos;s skills assessment for the energy industry.</p></div>
