...
const faqs = [
  { q: 'What are logistics and supply chain skill tests?', a: "Logistics and supply chain skill tests are pre-hire assessments that measure a candidate's ability to perform the actual tasks required in logistics, warehousing, procurement and planning roles. Unlike resumes, they give objective, role-specific data on skills like ERP proficiency, data analysis, safety awareness and demand forecasting before a single interview." },
  { q: 'How do I screen warehouse applicants at high volume without slowing down?', a: 'Send one assessment link to your entire applicant pool and Testlify auto-scores and ranks every candidate on operational aptitude, attention to detail and safety. During peak season you get a job-fit shortlist within hours instead of manually reviewing thousands of resumes.' },
  { q: 'Which skills should I test for logistics and supply chain roles?', a: 'Frontline roles need attention to detail, workplace safety, numerical reasoning and situational judgment. Strategic roles need Excel and analytics, ERP/SAP knowledge, SQL, demand forecasting and procurement skills. Testlify maps validated tests to both so every hire is measured on what the role actually demands.' },
  { q: 'Can logistics skill tests reduce warehouse turnover?', a: 'Yes. Hiring on verified reliability, safety awareness and operational aptitude — rather than availability alone — means new hires are better matched to the job and stay longer. Teams using skills-based screening report meaningfully lower early attrition on frontline roles.' },
  { q: 'Do the assessments work for nearshoring and cross-border supply chain roles?', a: 'Yes. Testlify includes tests for trade compliance, customs and documentation, network design and cross-border operations, so you can screen for the strategic and regulatory skills that nearshoring and network redesign require.' },
  { q: 'How do the assessments fit into our ATS and HRIS?', a: 'Testlify has 100+ native ATS and HRIS integrations including Workday, SAP SuccessFactors, Greenhouse, BambooHR and Lever. Assessments fire automatically and ranked results sync straight into your existing hiring workflow without manual data transfer.' },
  { q: "Are Testlify's supply chain skill tests valid and bias free?", a: 'Every test is built by subject-matter experts and I/O psychologists, validated for reliability and reviewed for adverse impact. Objective, consistent scoring gives every candidate the same fair evaluation and produces a defensible, documented hiring decision.' },
  { q: 'How fast can we launch assessments for a peak season hiring surge?', a: 'Minutes. Pick a role-specific logistics assessment or build your own from the test library, set your pass threshold, and send one link to your whole applicant pool. Candidates are scored and ranked automatically as they complete, so your shortlist builds in real time.' },
];
...
export default function LogisticsSupplyChainIndustryPage() {
    ...
    <>
      ...
      <section className="rt-hero" data-screen-label="Hero"><div className="rtw rt-hgrid">
        <div className="rt-copy reveal">
          <div className="rt-crumb"><Link href="/solution-index">Solutions</Link><span>/</span><span>Industry / Logistics &amp; supply chain</span></div>
          <p className="eyebrow">For logistics &amp; supply chain teams<b>.</b></p>
          <h1 className="rt-h1">Logistics and supply chain skill tests for <span style={{ color: '#F23F44' }}>every role you hire</span></h1>
          <p className="rt-lead">Assess warehouse, driver, planner and analyst candidates on the skills that predict performance. Screen applicants at volume, shortlist in days, and stop losing new hires.</p>
          ...
          <div className="rt-ticks">
            <span className="rt-tick"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#F23F44" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>7-day free trial</span>
            <span className="rt-tick"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#F23F44" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>Unlimited assessments</span>
            <span className="rt-tick"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#F23F44" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>No credit card required</span>
          </div>
        </div>
        <div className="rt-media reveal">
          <div className="fin-hero-card">
            <div className="lg-funh"><span>Frontline applicant funnel</span><span>Peak season</span></div>
            <div className="lg-funrow"><span className="lbl">Applicants</span><span className="lg-funbar" style={{ width: '100%' }}>3,499</span></div>
            <div className="lg-funrow"><span className="lbl">Assessed</span><span className="lg-funbar" style={{ width: '70%' }}>1,780</span></div>
            <div className="lg-funrow"><span className="lbl">Job-fit</span><span className="lg-funbar" style={{ width: '40%' }}>820</span></div>
            <div className="lg-funrow"><span className="lbl">Shortlist</span><span className="lg-funbar" style={{ width: '15%' }}>28</span></div>
            <div className="fin-score" style={{ marginTop: '20px' }}>
              <div className="en-scorehead"><div><b>Rohan M.</b><span className="sub">Demand Planner</span></div><span className="en-bigscore" style={{ fontSize: '19px' }}>Top 6%</span></div>
              <div className="rt-scores" style={{ marginTop: '14px' }}>
                <div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Excel &amp; Data Analysis</span><span className="rt-scbar"><i style={{ '--w': '92%' } as React.CSSProperties} /></span><span className="rt-scv">92</span></div>
                <div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Supply Chain Analytics</span><span className="rt-scbar"><i style={{ '--w': '88%' } as React.CSSProperties} /></span><span className="rt-scv">88</span></div>
                <div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>ERP / SAP knowledge</span><span className="rt-scbar"><i style={{ '--w': '87%' } as React.CSSProperties} /></span><span className="rt-scv">87</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="rtsec rtsand" style={{ paddingTop: '44px', paddingBottom: '44px' }}><div className="rtw">
        <div className="statrow reveal">
          <div className="stat"><div className="statn"><Counter to={22} /><span className="u">%</span></div><div className="statl">YoY growth in supply chain roles since 2020, with no sign of slowing</div></div>
          <div className="stat"><div className="statn"><Counter to={35} /><span className="u">%</span></div><div className="statl">of companies rank talent shortage as a top supply chain challenge</div></div>
          <div className="stat"><div className="statn"><Counter to={17} /><span className="u">%</span></div><div className="statl">projected employment growth for logistics 2024–2034, far above average</div></div>
          <div className="stat"><div className="statn">1.9<span className="u">M</span></div><div className="statl">US supply chain jobs projected to go unfilled by 2030</div></div>
        </div>
      </div></section>

      <section className="rtsec"><div className="rtw">
        <div className="rt-shead reveal"><h2 className="rt-h2">Exactly which skills do your logistics and supply chain roles need?</h2><p className="rt-lead">Testlify&apos;s validated skill library maps to both frontline and strategic logistics roles, so every test predicts on-the-job performance.</p></div>
        <div className="lg-2col reveal">
          <div className="lg-skillcard">
            <div className="lg-skhead"><span className="lg-skic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /></svg></span><h3>Frontline &amp; Operational skills</h3></div>
            <p className="lg-sksub">Warehouse, floor, forklift and fleet roles</p>
            <div className="rt-scores">
              <div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Attention to detail</span><span className="rt-scbar"><i style={{ '--w': '89%' } as React.CSSProperties} /></span><span className="rt-scv">89</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Workplace safety</span><span className="rt-scbar"><i style={{ '--w': '92%' } as React.CSSProperties} /></span><span className="rt-scv">92</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Numerical reasoning</span><span className="rt-scbar"><i style={{ '--w': '82%' } as React.CSSProperties} /></span><span className="rt-scv">82</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Reliability &amp; punctuality</span><span className="rt-scbar"><i style={{ '--w': '86%' } as React.CSSProperties} /></span><span className="rt-scv">86</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Spatial reasoning</span><span className="rt-scbar"><i style={{ '--w': '79%' } as React.CSSProperties} /></span><span className="rt-scv">79</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Situational judgement</span><span className="rt-scbar"><i style={{ '--w': '90%' } as React.CSSProperties} /></span><span className="rt-scv">90</span></div>
            </div>
          </div>
          <div className="lg-skillcard">
            <div className="lg-skhead"><span className="lg-skic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg></span><h3>Strategic &amp; Professional skills</h3></div>
            <p className="lg-sksub">Analyst, planner, procurement and ops manager</p>
            <div className="rt-scores">
              <div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Excel &amp; Analytics</span><span className="rt-scbar"><i style={{ '--w': '91%' } as React.CSSProperties} /></span><span className="rt-scv">91</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>ERP / SAP / Oracle</span><span className="rt-scbar"><i style={{ '--w': '86%' } as React.CSSProperties} /></span><span className="rt-scv">86</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>SQL &amp; Reporting</span><span className="rt-scbar"><i style={{ '--w': '77%' } as React.CSSProperties} /></span><span className="rt-scv">77</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Demand forecasting</span><span className="rt-scbar"><i style={{ '--w': '84%' } as React.CSSProperties} /></span><span className="rt-scv">84</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Procurement &amp; sourcing</span><span className="rt-scbar"><i style={{ '--w': '81%' } as React.CSSProperties} /></span><span className="rt-scv">81</span></div><div className="rt-scr"><span className="rt-scl" style={{ width: '168px' }}>Supply chain analytics</span><span className="rt-scbar"><i style={{ '--w': '88%' } as React.CSSProperties} /></span><span className="rt-scv">88</span></div>
            </div>
          </div>
        </div>
        <div style={{ textAlign: 'center' }}><Link className="rt-viewall reveal" href="/test-library">Browse the full test library<ArrowIcon /></Link></div>
      </div></section>

      <section className="rtsec rtsand"><div className="rtw">
        <div className="rt-shead reveal"><p className="eyebrow">How teams hire<b>.</b></p><h2 className="rt-h2">Built for how logistics teams actually hire</h2><p className="rt-lead">Whether you&apos;re ramping for peak season or building a planning team, Testlify fits the way your work works.</p></div>
        <div className="rt-roles reveal">
          <div className="rt-role"><div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><polyline points="3.27 6.96 12 12.01 20.73 6.96" /><line x1="12" y1="22.08" x2="12" y2="12" /></svg></span></div><h3>Peak season volume hiring</h3><p className="rt-role-d">Screen thousands of warehouse and fulfilment applicants in days, not weeks. Auto-rank candidates and shortlist the job-fit ones before your competitors do.</p><div className="rt-tags"><span className="rt-tag">High-volume</span><span className="rt-tag">Warehouse</span><span className="rt-tag">Frontline</span><span className="rt-tag">Seasonal</span></div></div>
          <div className="rt-role"><div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" /><line x1="3" y1="9" x2="21" y2="9" /><line x1="9" y1="21" x2="9" y2="9" /></svg></span></div><h3>Distribution centre buildout</h3><p className="rt-role-d">Rapidly assess and hire forklift operators, shift leads and logistics coordinators across multiple sites with one consistent skills benchmark.</p><div className="rt-tags"><span className="rt-tag">High-volume</span><span className="rt-tag">Warehouse</span><span className="rt-tag">Frontline</span></div></div>
          <div className="rt-role"><div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg></span></div><h3>Nearshoring &amp; network redesign</h3><p className="rt-role-d">As supply chains restructure, test candidates for strategic network design, trade compliance and cross-border operations the skills nearshoring demands.</p><div className="rt-tags"><span className="rt-tag">Strategic</span><span className="rt-tag">Compliance</span><span className="rt-tag">Cross-border</span></div></div>
          <div className="rt-role"><div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg></span></div><h3>Planning &amp; analytics team growth</h3><p className="rt-role-d">Validate Excel, SQL, ERP and forecasting proficiency for demand planners, supply-chain analysts and operations roles before the first interview.</p><div className="rt-tags"><span className="rt-tag">Planners</span><span className="rt-tag">Analysts</span><span className="rt-tag">ERP</span><span className="rt-tag">SQL</span></div></div>
          <div className="rt-role"><div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13" /><polygon points="16 8 20 8 23 11 23 16 16 16 16 8" /><circle cx="5.5" cy="18.5" r="2.5" /><circle cx="18.5" cy="18.5" r="2.5" /></svg></span></div><h3>Fleet &amp; driver hiring</h3><p className="rt-role-d">Assess route logic, safety awareness and service quality across a high-volume applicant pool. Reduce risky hires before they get behind the wheel.</p><div className="rt-tags"><span className="rt-tag">Drivers</span><span className="rt-tag">Fleet</span><span className="rt-tag">Safety</span><span className="rt-tag">High-volume</span></div></div>
          <div className="rt-role"><div className="rt-role-h"><span className="rt-role-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10z" /><path d="M2 21c0-3 1.85-5.36 5.08-6" /></svg></span></div><h3>Sustainability &amp; compliance hiring</h3><p className="rt-role-d">Test for Scope 3 emissions awareness, supplier governance and ESG reporting skills as sustainability regulations reshape supply chain hiring.</p><div className="rt-tags"><span className="rt-tag">ESG</span><span className="rt-tag">Compliance</span><span className="rt-tag">Procurement</span><span className="rt-tag">Governance</span></div></div>
        </div>
        <div style={{ textAlign: 'center' }}><Link className="rt-viewall reveal" href="/test-library">See volume hiring solutions<ArrowIcon /></Link></div>
      </div></section>

      <section className="rtsec"><div className="rtw">
        <div className="rt-shead reveal"><p className="eyebrow">Certifications<b>.</b></p><h2 className="rt-h2">Test for the certifications your industry values most</h2><p className="rt-lead">Testlify&apos;s logistics and supply chain skill tests cover the knowledge frameworks behind the most in-demand industry credentials.</p></div>
        <div className="lg-certgrid reveal">
          <div className="lg-cert"><p className="cf">APICS / ASCM</p><h3>CSCP &amp; CPIM aligned</h3><div className="ci"><Check /><span>Demand &amp; supply planning</span></div><div className="ci"><Check /><span>Inventory optimization</span></div><div className="ci"><Check /><span>Distribution &amp; logistics management</span></div></div>
          <div className="lg-cert"><p className="cf">Lean / Six Sigma</p><h3>Process improvement skills</h3><div className="ci"><Check /><span>DMAIC process knowledge</span></div><div className="ci"><Check /><span>Waste identification</span></div><div className="ci"><Check /><span>KPI measurement &amp; analysis</span></div></div>
          <div className="lg-cert"><p className="cf">WMS / TMS platforms</p><h3>Tech stack proficiency</h3><div className="ci"><Check /><span>SAP, Oracle &amp; Blue Yonder</span></div><div className="ci"><Check /><span>WMS operations &amp; workflows</span></div><div className="ci"><Check /><span>TMS reporting &amp; routing</span></div></div>
          <div className="lg-cert"><p className="cf">Trade &amp; compliance</p><h3>Regulatory &amp; legal knowledge</h3><div className="ci"><Check /><span>Customs &amp; import/export rules</span></div><div className="ci"><Check /><span>Incoterms &amp; documentation</span></div><div className="ci"><Check /><span>Tariff classification basics</span></div></div>
          <div className="lg-cert"><p className="cf">RFP / CPIM aligned</p><h3>Procurement &amp; sourcing</h3><div className="ci"><Check /><span>Supplier evaluation &amp; bid</span></div><div className="ci"><Check /><span>Category management</span></div><div className="ci"><Check /><span>Contract &amp; negotiation skills</span></div></div>
          <div className="lg-cert"><p className="cf">Safety &amp; OSHA</p><h3>Workplace safety compliance</h3><div className="ci"><Check /><span>OSHA standards &amp; regulations</span></div><div className="ci"><Check /><span>Forklift &amp; equipment safety</span></div><div className="ci"><Check /><span>Hazmat awareness &amp; protocols</span></div></div>
        </div>
      </div></section>

      <section className="rtsec lg-dark" data-screen-label="Client story"><div className="rtw" style={{ maxWidth: '960px', textAlign: 'center' }}>
        <p className="eyebrow reveal" style={{ color: '#C9B9BC' }}>Client story<b>.</b></p>
        <p className="lg-dq reveal">&quot;We were drowning in warehouse applicants every peak season. Testlify cut our screening from <span style={{ color: '#FF7A52' }}>weeks to days</span>, and the people we hire now actually stay past 90 days.&quot;</p>
        <p className="reveal" style={{ color: '#fff', fontWeight: 700, margin: 0 }}>Head of Talent</p>
        <p className="reveal" style={{ color: '#A9999C', fontSize: '14px', margin: '4px 0 40px' }}>Logistics Company</p>
        <div className="statrow reveal" style={{ gridTemplateColumns: 'repeat(3,1fr)', maxWidth: '720px', margin: '0 auto' }}>
          <div className="stat"><div className="statn"><Counter to={80} /><span className="u">%</span></div><div className="statl">faster time to shortlist</div></div>
          <div className="stat"><div className="statn"><Counter to={3} /><span className="u">×</span></div><div className="statl">faster time-to-hire</div></div>
          <div className="stat"><div className="statn"><Counter to={40} /><span className="u">%</span></div><div className="statl">lower 90-day attrition</div></div>
        </div>
      </div></section>
      ...
      <section className="rtsec rtsand"><div className="rtw">
        ...
        <div className="rt-atsmore reveal"><Link href="/integrations">View all ATS integration<ArrowIcon /></Link></div>
      </div></section>

      <section className="rtsec"><div className="rtw">
        <div className="rt-shead reveal"><p className="eyebrow">FAQ<b>.</b></p><h2 className="rt-h2">Frequently asked questions (FAQs)</h2><p className="rt-lead">Here are answers to the most commonly asked questions about Testlify&apos;s logistics and supply chain skill tests.</p></div>
        <div className="rt-faqw">
          {faqs.map((f, i) => (
            <div key={i} className={`rt-faq reveal ${open[i] ? 'rt-open' : ''}`} onClick={() => toggle(i)}>
