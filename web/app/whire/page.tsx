...
export default function WhirePage() {
  return (
    <>
...
` }} />
      ...
      <SiteHeader announcement="See how Whire hires faster with skills-first screening" />

      <section className="cs-hero"><div className="wrap">
        <p className="cs-crumb reveal in"><Link href="/customer-success-stories">Customers</Link><span className="sep">›</span><span>Recruitment tech</span><span className="sep">›</span><span>Whire</span></p>
        <div className="cs-logo reveal in"></div>
        <h1 className="cs-h1 reveal in">How Whire built skills-first shortlists and cut screening time in half</h1>
        <p className="cs-sub reveal in">Whire connects companies with vetted talent. To keep quality high at speed, they moved screening to the front of the funnel with Testlify.</p>
        <div className="cs-metrics reveal in">
          <div className="cs-metric"><div className="n">50%</div><div className="l">less time screening</div></div>
          <div className="cs-metric"><div className="n">2.8×</div><div className="l">more qualified shortlists</div></div>
          <div className="cs-metric"><div className="n">90%</div><div className="l">assessment completion</div></div>
        </div>
      </div></section>
        ...
        <div className="cs-body">
          <div>
            <div className="cs-block reveal"><h2>The challenge</h2>
              <p>Whire’s promise is vetted, ready-to-interview candidates. Delivering that meant a lot of manual screening — reading résumés and running early calls — which didn’t scale as demand grew.</p>
              <p>They needed a way to verify skill objectively and early, without adding headcount or slowing down the teams relying on them.</p>
            </div>
            <div className="cs-block reveal"><h2>The solution</h2>
              <p>Whire put a role-specific Testlify assessment at the very top of the funnel, so every candidate proves ability before a human reviews them.</p>
              <p>Recruiters now work from a ranked shortlist with scores and skill breakdowns attached, and add a short async video interview for senior roles.</p>
            </div>
            <div className="cs-quote reveal">
              <p>“Testlify let us verify skill at the top of the funnel. We deliver better shortlists in half the time — and our clients trust them.”</p>
              <div className="cs-qby"><span className="cs-qav"></span><span><span className="cs-qn">Talent Team</span><br /><span className="cs-qr">Whire</span></span></div>
            </div>
            <div className="cs-block reveal"><h2>The results</h2>
              <p>Screening time dropped by half while the quality of shortlists rose — 2.8× more candidates cleared later stages. Completion stayed at 90% thanks to short, candidate-friendly assessments.</p>
              <p>Whire scaled its vetting without adding recruiters, and every shortlist now comes with the evidence to back it.</p>
            </div>
          </div>
          <aside className="cs-card reveal">
            <h3>Company snapshot</h3>
            <ul className="cs-facts">
              <li><div className="k">Industry</div><div className="v">Recruitment technology</div></li>
              <li><div className="k">Company size</div><div className="v">11–50 employees</div></li>
              <li><div className="k">Location</div><div className="v">Europe</div></li>
              <li><div className="k">Use case</div><div className="v">Candidate vetting</div></li>
            </ul>
      ...
      <section className="sec" style={{ background: '#FBF3EE' }}><div className="wrap">
        ...
        <div className="cs-relgrid">
          ...
          <Link className="cs-relcard reveal" href="/customer-success-stories-detail"><div className="cs-relmetric">3.4× qualified hires</div><div className="cs-rellogo">Comeet</div><p>Structured assessment tightened our whole funnel.</p></Link>
        </div>
      </div></section>
