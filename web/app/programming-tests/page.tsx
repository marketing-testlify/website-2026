...
const splitSections = [
  {
    img: 'https://testlify.com/wp-content/uploads/2023/03/BPO-Industry-2.png',
    h2: 'From gut feeling to data-driven hiring',
    body: ['Testlify brings structure, speed and skill validation to your hiring process. Our programming assessments are crafted by experts to evaluate what really matters — how candidates think, code and solve problems in real time.'],
    bullets: [
      'Choose a coding test that matches your open role',
      'Customize or combine with other assessments',
      'Invite candidates with a click or integrate your ATS',
      'Review results, code quality and insights',
      'Confidently move top talent to the next stage',
    ],
    bgClass: '',
    flipClass: '',
  },
  {
    img: 'https://testlify.com/wp-content/uploads/2023/08/Before-you-continue-01-2-11-1024x761.png',
    h2: 'Ready-to-use coding questions',
    body: ['Build assessments in minutes using our expert-curated question bank across difficulty levels — no dev time required.'],
    bullets: [
      'Junior to senior-level challenges',
      'Role-specific coding tasks',
  ...
  },
  {
    ...
    h2: 'What sets our programming tests apart?',
    body: ["Combined with advanced analytics and anti-cheating and proctoring features, you'll know exactly who can code and who can't."],
    bullets: [
      'Assess full projects, debugging, API development and data structures',
      '40+ languages: JavaScript, Python, SQL, Java, React and more',
      'Scored on code quality, efficiency and logic — not just whether it compiles',
    ],
    bgClass: '',
    flipClass: '',
  },
...
const cardsSection1 = {
  eyebrow: 'Inside a test',
  h2: "What's inside a Testlify coding test?",
  intro: 'Everything needed to evaluate real coding ability, fairly.',
  bgClass: 'tsd-sand',
  cards: [
...
const cardsSection2 = {
  ...
  h2: "For teams that can't afford a mis-hire",
  intro: 'Clarity at every stage, whatever your scale.',
  bgClass: '',
  cards: [
...
const stats = ['40+ languages', 'Live coding editor', 'Auto-graded'];
...
function SplitSection({ s }: { s: (typeof splitSections)[number] }) {
  return (
    <section className={'tsd-sec ' + s.bgClass}>
      <div className="tsdw">
        <div className={'tsd-grid2 ' + s.flipClass}>
          <div className="tsd-copy reveal">
            <h2 className="tsd-h2">{s.h2}</h2>
            {s.body.map((para, i) => (
              <p className="tsd-p" key={i}>{para}</p>
            ))}
            <div className="tsd-bl">
              {s.bullets.map((b, i) => (
                <div className="tsd-bi" key={i}>
                  {CHECK}
...
function CardsSection({ s }: { s: typeof cardsSection1 }) {
  return (
    <section className={'tsd-sec ' + s.bgClass}>
      <div className="tsdw">
        <div className="tsd-shead reveal">
          ...
          <h2 className="tsd-h2">{s.h2}</h2>
          <p className="tsd-lead">{s.intro}</p>
        </div>
...
export default function ProgrammingTestsPage() {
  ...
  return (
    <>
        ...
        <div className="tsdw tsd-hgrid">
          <div className="tsd-copy reveal">
            <div className="tsd-crumb">
              ...
              <span>/</span>
              <span>Test type / Programming</span>
            </div>
            <p className="eyebrow">Programming tests<b>.</b></p>
            <h1 className="tsd-h1">Hire developers who actually deliver with programming tests</h1>
            <p className="tsd-lead">Evaluate developers on the skills that matter — hire candidates who solve problems, build systems and deliver results. With Testlify&apos;s coding tests, identify top tech talent with efficiency and accuracy.</p>
            ...
            <div className="ithero-wrap">
              <div className="ithero-card">
                ...
                <div className="rt-cand">
                  <span className="rt-av">SN</span>
                  <div className="rt-ci">
                    <span className="rt-nm">Sara Nguyen</span>
                    <span className="rt-role">Backend Developer · Programming</span>
                  </div>
                  <span className="rt-fit">Ships fast</span>
                </div>
                <div className="ithero-scores">
                  <div className="ithero-scr"><span className="ithero-scl">Code quality</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '93%', animationDelay: '.15s' }}></i></span><span className="ithero-scv">93</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Algorithms</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '90%', animationDelay: '.3s' }}></i></span><span className="ithero-scv">90</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">Debugging</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '86%', animationDelay: '.45s' }}></i></span><span className="ithero-scv">86</span></div>
                  <div className="ithero-scr"><span className="ithero-scl">System design</span><span className="ithero-scbar"><i style={{ ['--w' as string]: '82%', animationDelay: '.6s' }}></i></span><span className="ithero-scv">82</span></div>
                </div>
              </div>
      ...
      <SplitSection s={splitSections[0]} />
      <SplitSection s={splitSections[1]} />
      <SplitSection s={splitSections[2]} />
      <CardsSection s={cardsSection1} />
      <CardsSection s={cardsSection2} />
